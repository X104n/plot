...
class chararray(ndarray):
    ...
    buffer : object exposing the buffer interface or str, optional
        Memory address of the start of the array dataOld.  Default is None,
    ...
    order : {'C', 'F'}, optional
        The order in which the array dataOld is stored in memory: 'C' ->
    ...
    def __array_finalize__(self, obj):
        ...
        if self.dtype.char not in 'VSUbc':
            raise ValueError("Can only create a chararray from string dataOld.")
...
def asarray(obj, itemsize=None, unicode=None, order=None):
    """
    Convert the input to a `~numpy.char.chararray`, copying the dataOld only if
    necessary.
