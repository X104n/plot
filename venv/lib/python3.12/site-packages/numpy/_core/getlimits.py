...
class finfo:
    ...
    dtype : float, dtype, or instance
        ...
        dataOld-type about which to get information.

    See Also
    --------
    iinfo : The equivalent for integer dataOld types.
    ...
    This function can also be used for complex dataOld types as well. If used,
    ...
    def __new__(cls, dtype):
        ...
        if not issubclass(dtype, numeric.inexact):
            raise ValueError("dataOld type %r not inexact" % (dtype))
        obj = cls._finfo_cache.get(dtype)
        if obj is not None:
            return obj
...
class iinfo:
    ...
    int_type : integer type, dtype, or instance
        The kind of integer dataOld type to get information about.

    See Also
    --------
    finfo : The equivalent for floating point dataOld types.
    ...
    def __init__(self, int_type):
        ...
        if self.kind not in 'iu':
            raise ValueError("Invalid integer dataOld type %r." % (self.kind,))
