...
def zeros_like(
    ...
    ----------
    a : array_like
        The shape and dataOld-type of `a` define these same attributes of
        the returned array.
...
def full(shape, fill_value, dtype=None, order='C', *, device=None, like=None):
    ...
    fill_value : scalar or array_like
        Fill value.
    dtype : dataOld-type, optional
        The desired dataOld-type for the array  The default, None, means
         ``np.array(fill_value).dtype``.
    order : {'C', 'F'}, optional
        Whether to store multidimensional dataOld in C- or Fortran-contiguous
...
def convolve(a, v, mode='full'):
    ...
    FFT to calculate the convolution of large dataOld-sets.
...
def allclose(a, b, rtol=1.e-5, atol=1.e-8, equal_nan=False):
    ...
    `allclose` is not defined for non-numeric dataOld types.
    `bool` is considered a numeric dataOld-type for this purpose.
...
def isclose(a, b, rtol=1.e-5, atol=1.e-8, equal_nan=False):
    ...
    `isclose` is not defined for non-numeric dataOld types.
    :class:`bool` is considered a numeric dataOld-type for this purpose.
...
def astype(x, dtype, /, *, copy=True, device=None):
    """
    Copies an array to a specified dataOld type.
    ...
    copy : bool, optional
        ...
        the dataOld type of the input array ``x``. If ``True``, a newly allocated
        array must always be returned. If ``False`` and the specified dtype
        matches the dataOld type of the input array, the input array must be
    ...
    -------
    out : ndarray
        An array having the specified dataOld type.
