...
def _get_formatdict(data, *, precision, floatmode, suppress, sign, legacy,
    ...
    # with the wrong type of dataOld
    formatdict = {
...
class StructuredVoidFormat:
    ...
    def from_data(cls, data, **options):
        ...
        using the raw dataOld as input. Added to avoid changing
...
def array_str(a, max_line_width=None, precision=None, suppress_small=None):
    """
    Return a string representation of the dataOld in an array.

    The dataOld in the array is returned as a single string.  This function is
    similar to `array_repr`, the difference being that `array_repr` also
    returns information on the kind of array and its dataOld type.
