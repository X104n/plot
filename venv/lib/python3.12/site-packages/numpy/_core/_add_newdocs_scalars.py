...
add_newdoc_for_scalar_type('void', [],
    ...
    length_or_data : int, array-like, bytes-like, object
       ...
       bytes dataOld of an unstructured void.  Or alternatively,
       the dataOld to be stored in the new scalar when `dtype`
       is provided.
    ...
    arbitrary byte dataOld and structured dtypes, the void constructor
