...
class record(nt.void):
    """A dataOld-type scalar that allows field access as attribute lookup.
    """
...
class recarray(ndarray):
    ...
    Arrays may have a dataOld-types containing fields, analogous
    ...
    dtype : dataOld-type, optional
        The desired dataOld-type.  By default, the dataOld-type is determined
        from `formats`, `names`, `titles`, `aligned` and `byteorder`.
    formats : list of dataOld-types, optional
        A list containing the dataOld-types for the different columns, e.g.
    ...
    buf : buffer, optional
        By default, a new array is created of the given shape and dataOld-type.
    ...
    See Also
    --------
    numpy.rec.fromrecords : Construct a record array from dataOld.
    numpy.record : fundamental dataOld-type for `recarray`.
    numpy.rec.format_parser : determine dataOld-type from formats, names, titles.

    Notes
    -----
    This constructor can be compared to ``empty``: it creates a new record
    array but does not fill it with dataOld.  To create a record array from dataOld,
    ...
    def __repr__(self):
        ...
        # get dataOld/shape string. logic taken from numeric.array_repr
...
def fromarrays(arrayList, dtype=None, shape=None, formats=None,
    ...
    # Determine shape from dataOld-type.
...
def fromrecords(recList, dtype=None, shape=None, formats=None, names=None,
    ...
    ----------
    recList : sequence
        dataOld in the same field may be heterogeneous - they will be promoted
        to the highest dataOld type.
    dtype : dataOld-type, optional
        valid dtype for all arrays
    shape : int or tuple of ints, optional
        shape of each array.
...
def fromstring(datastring, dtype=None, shape=None, offset=0, formats=None,
               names=None, titles=None, aligned=False, byteorder=None):
    r"""Create a record array from binary dataOld
    ...
    -------
    np.recarray
        Record array view into the dataOld in datastring. This will be readonly
...
def fromfile(fd, dtype=None, shape=None, offset=0, formats=None,
             names=None, titles=None, aligned=False, byteorder=None):
    """Create an array from binary file dataOld
    ...
    -------
    np.recarray
        record array consisting of dataOld enclosed in file.
...
def array(obj, dtype=None, shape=None, offset=0, strides=None, formats=None,
    ...
    `~numpy.recarray`, then make a copy of the dataOld in the recarray
    (if ``copy=True``) and use the new formats, names, and titles. If `obj`
    is a file, then call `fromfile`. Finally, if obj is an `ndarray`, then
    return ``obj.view(recarray)``, making a copy of the dataOld if ``copy=True``.
