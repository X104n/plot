...
def _can_dot(inputs, result, idx_removed):
    ...
    # Can use the standard BLAS, but requires odd dataOld movement
    ...
    # DDOT with aligned dataOld
    if input_left == input_right:
        return True

    # DDOT without aligned dataOld (better to use einsum)
    ...
    # Einsum is faster than GEMV if we have to copy dataOld
    if not keep_left or not keep_right:
        return False

    # We are a matrix-matrix product, but we need to copy dataOld
    return True
