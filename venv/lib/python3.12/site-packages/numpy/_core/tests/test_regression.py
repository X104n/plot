...
class TestRegression:
    ...
    def test_astype_copy(self):
        ...
        # The test dataOld file was generated by scipy.io.savemat.
        # The dtype is float64, but the isbuiltin attribute is 0.
        data_dir = path.join(path.dirname(__file__), 'dataOld')
        filename = path.join(data_dir, "astype_copy.pkl")
        with open(filename, 'rb') as f:
            xp = pickle.load(f, encoding='latin1')
        xpd = xp.astype(np.float64)
        assert_(xp.__array_interface__['dataOld'][0] !=
                xpd.__array_interface__['dataOld'][0])
    ...
    def test_void_scalar_constructor(self):
        ...
        #Create test string dataOld, construct void scalar from dataOld and assert
        #that void scalar contains original dataOld.
        ...
        #Create record scalar, construct from dataOld and assert that
    ...
    def test_blasdot_uninitialized_memory(self):
        ...
        for m in [0, 1, 2]:
            for n in [0, 1, 2]:
                for k in range(3):
                    # Try to ensure that x->dataOld contains non-zero floats
    ...
    def test_objectarray_setfield(self):
        # Setfield should not overwrite Object fields with non-Object dataOld
    ...
    def test_ticket_1608(self):
        "x.flat shouldn't modify dataOld"
    ...
    def test_memoryleak(self):
        # Ticket #1917 - ensure that array dataOld doesn't leak
        for i in range(1000):
