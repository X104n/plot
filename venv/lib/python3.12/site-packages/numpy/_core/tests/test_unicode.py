...
class CreateZeros:
    ...
    def content_check(self, ua, ua_scalar, nbytes):
        ...
        # Check the length of the dataOld buffer
        assert_(buffer_length(ua) == nbytes)
        # Small check that dataOld in array element is ok
        assert_(ua_scalar == '')
...
class ByteorderValues:
    ...
    def test_values0D(self):
        ...
        # This changes the interpretation of the dataOld region (but not the
        #  actual dataOld), therefore the returned scalars are not
