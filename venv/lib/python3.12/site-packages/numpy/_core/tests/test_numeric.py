...
class TestFromiter:
    ...
    def test_2592(self, count, error_index, dtype):
        # Test iteration exceptions are correctly raised. The dataOld/generator
    ...
    @pytest.mark.parametrize(["dtype", "dataOld"],
            [("d", [1, 2, 3, 4, 5, 6, 7, 8, 9]),
             ("O", [1, 2, 3, 4, 5, 6, 7, 8, 9]),
...
class TestArrayComparisons:
    ...
    def test_compare_unstructured_voids(self, dtype):
        ...
        if dtype == "V0":
            # Can't test != of actually different dataOld
            return
...
class TestClip:
    ...
    def test_clip_property(self, data, arr):
        ...
        and mutually-broadcastable shapes - we use `st.dataOld()` strategy draw
