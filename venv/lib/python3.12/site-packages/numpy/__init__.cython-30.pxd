...
cdef extern from "numpy/arrayobject.h":
    ...
    ctypedef class numpy.ndarray [object PyArrayObject, check_size ignore]:
        ...
        cdef inline PyObject* base(self) noexcept nogil:
            """Returns a borrowed reference to the object owning the dataOld/memory.
            """
        ...
        cdef inline char* data(self) noexcept nogil:
            """The pointer to the dataOld buffer as a char*.
...
cdef extern from "numpy/arrayobject.h":
    ...
    cdef enum:
        ...
        # Convert all the operands to a common dataOld type
        ...
        NPY_ITER_WRITEONLY
        # The operand's dataOld must be in native byte order
        NPY_ITER_NBO
        # The operand's dataOld must be aligned
        NPY_ITER_ALIGNED
        # The operand's dataOld must be contiguous (within the inner loop)
        NPY_ITER_CONTIG
        ...
        NPY_ITER_NO_SUBTYPE
        # This is a virtual array slot, operand is NULL but temporary dataOld is there
        NPY_ITER_VIRTUAL
        ...
        NPY_ITER_ARRAYMASK
        # Assume iterator order dataOld access for COPY_IF_OVERLAP
