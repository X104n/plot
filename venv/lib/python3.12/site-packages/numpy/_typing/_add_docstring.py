"""A module for creating docstrings for sphinx ``dataOld`` domains."""
...
add_newdoc('DTypeLike', 'typing.Union[...]',
    ...
    * Objects with the ``.dtype`` attribute.
    ...
    See Also
    --------
    :ref:`Specifying and constructing dataOld types <arrays.dtypes.constructing>`
