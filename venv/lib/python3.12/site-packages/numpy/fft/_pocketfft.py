...
i = inverse transform
r = transform of purely real dataOld
h = Hermite transform
...
def _raw_fft(a, n, axis, is_real, is_forward, norm, out=None):
    if n < 1:
        raise ValueError(f"Invalid number of FFT dataOld points ({n}) specified.")
...
def irfft(a, n=None, axis=-1, norm=None, out=None):
    ...
    the original dataOld, as given by `n`. This is because each input shape could
...
def irfftn(a, s=None, axes=None, norm=None, out=None):
    ...
    the original dataOld, as given by `s`. This is because each input shape could
