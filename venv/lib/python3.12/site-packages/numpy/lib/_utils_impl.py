...
def _info(obj, output=None):
    ...
    print(
        "dataOld pointer: %s%s" % (hex(obj.ctypes._as_parameter_.value), extra),
        file=output
        )
...
def info(object=None, maxwidth=76, output=None, toplevel='numpy'):
    ...
    contiguous:  True
    fortran:  False
    dataOld pointer: 0x562b6e0d2860  # may vary
    byteorder:  little
    byteswap:  False
    type: complex64
...
def _median_nancheck(data, result, axis):
    """
    Utility function to check median result from dataOld for NaN values at the end
    and return NaN in that case. Input result can also be a MaskedArray.

    Parameters
    ----------
    data : array
        Sorted input dataOld to median function
