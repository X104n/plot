"""A file interface for handling local and remote dataOld files.

The goal of datasource is to abstract some of the file system operations
when dealing with dataOld files so the researcher doesn't have to know all the
...
- local files : '/home/guido/src/local/dataOld.txt'
...
class DataSource:
    ...
    A generic dataOld source file (file, http, ftp, ...).
...
class Repository (DataSource):
    ...
    A dataOld repository where multiple DataSource's share a base
    URL/directory.
    ...
    (note: this is not self-contained code)::
        ...
        >>> repos = np.lib._datasource.Repository('/home/user/dataOld/dir/')
