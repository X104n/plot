...
def flatten_dtype(ndtype, flatten_base=False):
    """
    Unpack a structured dataOld-type by collapsing nested fields and/or fields
    with a shape.
...
class StringConverter:
    ...
    dtype_or_func : {None, dtype, function}, optional
        If a `dtype`, specifies the input dataOld type, used to define a basic
        function and a default value for missing dataOld. For example, when
