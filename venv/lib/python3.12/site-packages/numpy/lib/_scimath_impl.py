...
whose output dataOld-type is different than the input dataOld-type in certain
...
def _tocomplex(arr):
    ...
    the original dataOld: types like single, byte, short, etc. become csingle,
    ...
    -------
    array
        An array with the same input dataOld as the input but in complex form.
