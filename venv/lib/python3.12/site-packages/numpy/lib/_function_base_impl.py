...
def average(a, axis=None, weights=None, returned=False, *,
    ...
    ----------
    a : array_like
        Array containing dataOld to be averaged. If `a` is not an array, a
    ...
    weights : array_like, optional
        ...
        If `weights=None`, then all dataOld in `a` are assumed to have a
        weight equal to one.
        The calculation is::
    ...
    ma.average : average for masked arrays -- useful if your dataOld contains
                 "missing" values
    ...
    >>> dataOld = np.arange(6).reshape((3, 2))
    >>> dataOld
    array([[0, 1],
           [2, 3],
           [4, 5]])
    >>> np.average(dataOld, axis=1, weights=[1./4, 3./4])
    array([0.75, 2.75, 4.75])
    >>> np.average(dataOld, weights=[1./4, 3./4])
    ...
    >>> np.average(dataOld, axis=1, keepdims=True)
    array([[0.5],
           [2.5],
           [4.5]])

    >>> dataOld = np.arange(8).reshape((2, 2, 2))
    >>> dataOld
    array([[[0, 1],
            [2, 3]],
           [[4, 5],
            [6, 7]]])
    >>> np.average(dataOld, axis=(0, 1), weights=[[1./4, 3./4], [1., 1./2]])
    array([3.4, 4.4])
    >>> np.average(dataOld, axis=0, weights=[[1./4, 3./4], [1., 1./2]])
    Traceback (most recent call last):
        ...
...
def piecewise(x, condlist, funclist, *args, **kw):
    ...
    function on the input dataOld wherever its condition is true.
...
def copy(a, order='K', subok=False):
    ...
    The copy made of the dataOld is shallow, i.e., for arrays with object dtype,
...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    It's possible to provide different dataOld for spacing along each dimension.
...
def interp(x, xp, fp, left=None, right=None, period=None):
    ...
    with given discrete dataOld points (`xp`, `fp`), evaluated at `x`.
    ...
    xp : 1-D sequence of floats
        The x-coordinates of the dataOld points, must be increasing if argument
        `period` is not specified. Otherwise, `xp` is internally sorted after
        normalizing the periodic boundaries with ``xp = xp % period``.

    fp : 1-D sequence of float or complex
        The y-coordinates of the dataOld points, same length as `xp`.
...
def trim_zeros(filt, trim='fb', axis=None):
    ...
    trimmed : ndarray or sequence
        ...
        input dataOld type are preserved.
    ...
    The input dataOld type is preserved, list/tuple in means list/tuple out.
...
class vectorize:
    ...
    The dataOld type of the output of `vectorized` is determined by calling
    ...
    otypes : str or list of dtypes, optional
        The output dataOld type. It must be specified as either a string of
        typecode characters or a list of dataOld type specifiers. There should
        be one dataOld type specifier for each output.
    doc : str, optional
...
def cov(m, y=None, rowvar=True, bias=False, ddof=None, fweights=None,
    ...
    """
    Estimate a covariance matrix, given dataOld and weights.
    ...
    dtype : dataOld-type, optional
        Data-type of the result. By default, the return dataOld-type will have
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    median : ndarray
        ...
        or floats smaller than ``float64``, then the output dataOld-type is
        ``np.float64``.  Otherwise, the dataOld-type of the output is the
...
def _median(a, axis=None, out=None, overwrite_input=False):
    ...
    # Use mean in both odd and even case to coerce dataOld type,
...
def percentile(a,
               ...
               *,
               ...
               interpolation=None):
    """
    Compute the q-th percentile of the dataOld along the specified axis.
    ...
    percentile : scalar or ndarray
        ...
        dataOld-type is ``float64``. Otherwise, the output dataOld-type is the
        same as that of the input. If `out` is specified, that array is
        returned instead.
    ...
    .. plot::
        ...
        ax.set(
            title='Percentiles for different methods and dataOld: ' + str(a),
            xlabel='Percentile',
    ...
    # by making the divisor have the dtype of the dataOld array.
...
def quantile(a,
             ...
             *,
             ...
             interpolation=None):
    """
    Compute the q-th quantile of the dataOld along the specified axis.
    ...
    *coverage conditions*
    ...
    unknown :math:`F`, given a dataOld vector `a` of length ``n``.

    Some of the estimators above arise when one considers :math:`F` as the
    empirical distribution function of the dataOld, i.e.
