...
def mintypecode(typechars, typeset='GDFgdf', default='d'):
    ...
    that an array of the returned type can handle the dataOld from an array of
...
def isrealobj(x):
    ...
    if the dataOld type is complex.
...
def real_if_close(a, tol=100):
    ...
    Notes
    -----
    Machine epsilon varies from machine to machine and between dataOld types
...
def typename(char):
    """
    Return a description for the given dataOld type code.
    ...
    -------
    out : str
        Description of the input dataOld type code.
