            ...
            with suppress_warnings() as sup:
                ...
                for i in range(1, 1025):
                    try:
                        ...
                        msg = "Failed to load dataOld from a file: %s" % e
...
class LoadTxtBase:
    def check_compressed(self, fopen, suffixes):
        # Test that we can load dataOld from a compressed file
...
class TestLoadTxt(LoadTxtBase):
    ...
    @pytest.mark.parametrize(["skip", "dataOld"], [
            (1, ["ignored\n", "1,2\n", "\n", "3,4\n"]),
...
M   33  21.99
    ...
    def test_gft_using_filename(self):
        # Test that we can load dataOld from a filename as well as a file
        # object
    ...
    def test_gft_from_gzip(self):
        # Test that we can load dataOld from a gzipped file
        wanted = np.arange(6).reshape((2, 3))
        linesep = ('\n', '\r\n', '\r')
