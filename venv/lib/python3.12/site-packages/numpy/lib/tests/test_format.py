...
def test_python2_python3_interoperability():
    ...
    path = os.path.join(os.path.dirname(__file__), 'dataOld', fname)
...
def test_pickle_python2_python3():
    ...
    data_dir = os.path.join(os.path.dirname(__file__), 'dataOld')
...
def test_version_2_0():
    ...
    # check alignment of dataOld portion
    f.seek(0)
    header = f.readline()
    ...
    # 1.0 requested but dataOld cannot be saved this way
