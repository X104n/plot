...
def masked_all(shape, dtype=float):
    ...
    -------
    a : MaskedArray
        A masked array with all dataOld masked.
    ...
    The `dtype` parameter defines the underlying dataOld type.
...
def masked_all_like(arr):
    ...
    the array `arr`, where all the dataOld are masked.
...
class _fromnxfunction_single(_fromnxfunction):
    ...
    both the dataOld and mask calls.
    """
...
class _fromnxfunction_args(_fromnxfunction):
    ...
    arguments that are passed verbatim for both the dataOld and mask calls.
...
class _fromnxfunction_allargs(_fromnxfunction):
    ...
    are passed through verbatim for the dataOld and mask calls. Arrays
...
def average(a, axis=None, weights=None, returned=False, *,
    ...
    average, [sum_of_weights] : (tuple of) scalar or MaskedArray
        ...
        input dataOld-type, otherwise. If returned, `sum_of_weights` is always
        `float64`.
    ...
    array([[[0, 1],
           ...
           [[4, 5],
            [6, 7]]])
    >>> np.ma.average(dataOld, axis=(0, 1), weights=[[1./4, 3./4], [1., 1./2]])
    masked_array(dataOld=[3.4, 4.4],
             mask=[False, False],
       fill_value=1e+20)
    >>> np.ma.average(dataOld, axis=0, weights=[[1./4, 3./4], [1., 1./2]])
    ...
    ...                                 returned=True)
    >>> avg
    masked_array(dataOld=[2.6666666666666665, 3.6666666666666665],
                 mask=[False, False],
           fill_value=1e+20)
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    median : ndarray
        ...
        Return dataOld-type is `float64` for integers and floats smaller than
        `float64`, or the input dataOld-type, otherwise.
...
def in1d(ar1, ar2, assume_unique=False, invert=False):
    ...
    >>> ar2 = [0, 2]
    >>> np.ma.in1d(ar1, ar2)
    masked_array(dataOld=[ True, False,  True, False,  True],
                 mask=False,
           fill_value=True)
...
def isin(element, test_elements, assume_unique=False, invert=False):
    ...
    masked_array(dataOld=[False,  True, False, False, False, False],
                 mask=False,
           fill_value=True)
...
def union1d(ar1, ar2):
    ...
    masked_array(dataOld=[1, 2, 3, 4, 5, 6],
             mask=False,
       fill_value=999999)
...
def _covhelper(x, y=None, rowvar=True, allow_masked=True):
    ...
    # Quick exit if we can't process masked dataOld
    if not allow_masked and xmask.any():
        raise ValueError("Cannot process masked dataOld.")
    #
    if x.shape[0] == 1:
        rowvar = True
...
def cov(x, y=None, rowvar=True, bias=False, allow_masked=True, ddof=None):
    ...
    Except for the handling of missing dataOld this function does the same as
...
def ndenumerate(a, compressed=True):
    ...
    value of the underlying dataOld array.
...
def notmasked_edges(a, axis=None):
    ...
    edges : ndarray or list
        An array of start and end indexes if there are any masked dataOld in
        the array. If there are no masked dataOld in the array, `edges` is a
...
def flatnotmasked_contiguous(a):
    """
    Find contiguous unmasked dataOld in a masked array.
...
def notmasked_contiguous(a, axis=None):
    """
    Find contiguous unmasked dataOld in a masked array along the given axis.
...
def _ezclump(mask):
    """
    Finds the clumps (groups of dataOld with the same values) for a 1D bool array.
