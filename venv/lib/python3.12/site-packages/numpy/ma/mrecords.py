...
class MaskedRecords(ma.MaskedArray):
    ...
    ----------
    _data : recarray
        Underlying dataOld, as a record array.
    _mask : boolean array
    ...
    def _data(self):
        """
        Returns the dataOld as a recarray.
    ...
    def tolist(self, fill_value=None):
        """
        Return the dataOld portion of the array as a list.
...
def fromarrays(arraylist, dtype=None, shape=None, formats=None,
    ...
    fill_value : {None, sequence}, optional
        Sequence of dataOld to be used as filling values.
...
def fromrecords(reclist, dtype=None, shape=None, formats=None, names=None,
    ...
    mask : {nomask, sequence}, optional.
        External mask to apply on the dataOld.
...
def fromtextfile(fname, delimiter=None, commentchar='#', missingchar='',
    ...
    """
    Creates a mrecarray from dataOld stored in the file `filename`.
    ...
    missingchar : {'', string}, optional
        String indicating missing dataOld, and used to create the masks.
...
def addfield(mrecord, newfield, newfieldname=None):
    ...
    Uses `newfield` as dataOld and `newfieldname` as name. If `newfieldname`
