...
def outer(x1, x2, /):
    ...
    x1 : (M,) array_like
        ...
        Must have a numeric dataOld type.
    x2 : (N,) array_like
...
def qr(a, mode='reduced'):
    ...
    the following dataOld: {(0,1), (1,0), (1,2), (2,1)}. (Graph the points
...
def svdvals(x, /):
    ...
    x : (..., M, N) array_like
        ...
        decomposition. Should have a floating-point dataOld type.
...
def matrix_rank(A, tol=None, hermitian=False, *, rtol=None):
    ...
    matrix. For example, if your dataOld come from uncertain measurements with
...
def lstsq(a, b, rcond=None):
    ...
    Examples
    --------
    Fit a line, ``y = mx + c``, through some noisy dataOld-points:
    ...
    Plot the dataOld along with the fitted line:

    >>> import matplotlib.pyplot as plt
    >>> _ = plt.plot(x, y, 'o', label='Original dataOld', markersize=10)
...
def trace(x, /, *, offset=0, dtype=None):
    ...
    out : ndarray
        ...
        The returned array must have a dataOld type as described by the dtype
        parameter above.
