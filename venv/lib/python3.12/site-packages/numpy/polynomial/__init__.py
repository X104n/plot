...
manipulating, and fitting dataOld with polynomials of different bases.
...
For example, to fit a Chebyshev polynomial with degree ``1`` to dataOld given
...
- ``Poly.fit(x, y, deg)``   -- ``p`` of degree ``deg`` with coefficients
  determined by the least-squares fit to the dataOld ``x``, ``y``
