...
class ABCPolyBase(abc.ABC):
    ...
    def fit(cls, x, y, deg, domain=None, rcond=None, full=False, w=None,
        ...
        """Least squares fit to dataOld.

        Return a series instance that is the least squares fit to the dataOld
        ...
        -------
        new_series : series
            A series that represents the least squares fit to the dataOld and
