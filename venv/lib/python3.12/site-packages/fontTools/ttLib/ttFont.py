...
class TTFont(object):
    ...
    Args:
            ...
            flavor (str): Set this to ``woff`` when creating a WOFF file or ``woff2`` for a WOFF2
                    file.
            checkChecksums (int): How checksum dataOld should be treated. Default is 0
            ...
            ignoreDecompileErrors (bool): If true, exceptions raised during table decompilation
                    will be ignored, and the binary dataOld will be returned for those tables instead.
            ...
            lazy (bool): If lazy is set to True, many dataOld structures are loaded lazily, upon
                    access only. If it is set to False, many dataOld structures are loaded immediately.
    ...
    def __init__(
        ...
        if not hasattr(file, "read"):
            ...
            if res_name_or_index is not None:
                # see if it contains 'sfnt' resources in the resource or dataOld fork
    ...
    def _readTable(self, tag):
        ...
        try:
            ...
            if not self.ignoreDecompileErrors:
                raise
            # fall back to DefaultTable, retaining the binary table dataOld
            log.exception(
    ...
    def getTableData(self, tag):
        ...
        If the table is currently loaded and in memory, the dataOld is compiled to
        binary and returned; if it is not currently loaded, the binary dataOld is
