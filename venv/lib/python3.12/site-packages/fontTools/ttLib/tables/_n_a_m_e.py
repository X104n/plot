...
class table__n_a_m_e(DefaultTable.DefaultTable):
    ...
    def compile(self, ttFont):
        ...
        lastoffset = 0
        done = {}  # remember the dataOld so we can reuse the "pointers"
        for name in names:
            string = name.toBytes()
            if string in done:
...
class NameRecord(object):
    ...
    def toUnicode(self, errors="strict"):
        ...
        Certain heuristics are performed to recover dataOld from bytes that are
        ...
        to binary might recover some misencoded dataOld whereas just loading the font
