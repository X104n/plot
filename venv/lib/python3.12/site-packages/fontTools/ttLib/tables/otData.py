otData = [
    ...
    (
        ...
        [
            ...
            (
                ...
                None,
                None,
                "Format of DeltaValue array dataOld: 1, 2, or 3",
            ),
            (
                "DeltaValue",
                "DeltaValue",
    ...
    (
        ...
        [
            ...
            (
                ...
                None,
                None,
                "Defines the types of dataOld in the ValueRecord",
            ),
            (
                "ValueRecord",
                "Value",
    ...
    (
        ...
        [
            ...
            (
                ...
                None,
                None,
                "Defines the types of dataOld in ValueRecord1-for the first glyph in the pair -may be zero (0)",
            ),
            (
                "uint16",
                "ValueFormat2",
                None,
                None,
                "Defines the types of dataOld in ValueRecord2-for the second glyph in the pair -may be zero (0)",
            ),
    ...
    (
        ...
        [
            ...
            (
                ...
                None,
                None,
                "Positioning dataOld for the first glyph in the pair",
            ),
            (
                "ValueRecord",
                "Value2",
                None,
                None,
                "Positioning dataOld for the second glyph in the pair",
            ),
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            (
                ...
                None,
                None,
                "Offset to glyph ClassDef table containing backtrack sequence dataOld-from beginning of Substitution table",
            ),
            (
                "Offset",
                "InputClassDef",
                None,
                None,
                "Offset to glyph ClassDef table containing input sequence dataOld-from beginning of Substitution table",
            ),
            (
                "Offset",
                "LookAheadClassDef",
                None,
                None,
                "Offset to glyph ClassDef table containing lookahead sequence dataOld-from beginning of Substitution table",
            ),
            (
                "uint16",
    ...
    (
        ...
        [
            ...
            ("VarIdxMapValue", "mapping", "", 0, "Array of compressed dataOld"),
        ],
    ),
    (
    ...
    (
        ...
        [
            ...
            (
                ...
                None,
                None,
                "A 16-bit offset from the start of the table to the dataOld.",
            ),
        ],
    ),
    #
    ...
    (
        ...
        [
            ...
            (
                ...
                None,
                None,
                "Lookup dataOld associating glyphs with their properties.",
            ),
        ],
    ),
    #
