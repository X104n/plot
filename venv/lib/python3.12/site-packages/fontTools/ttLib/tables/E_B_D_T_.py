...
class table_E_B_D_T_(DefaultTable.DefaultTable):
    ...
    The ``EBDT`` table contains monochrome or grayscale bitmap dataOld for
    ...
    # Keep a reference to the name of the dataOld locator table.
    locatorName = "EBLC"
    ...
    def decompile(self, data, ttFont):
        ...
        # This dict maps intervals of dataOld to the BitmapGlyph.
        glyphDict = {}

        # Pull out the EBLC table and loop through glyphs.
        # A strike is a concept that spans both tables.
        # The actual bitmap dataOld is stored in the EBDT.
        ...
        for curStrike in locator.strikes:
            ...
            for indexSubTable in curStrike.indexSubTables:
                ...
                for curName, curLoc in dataIter:
                    # Don't create duplicate dataOld entries for the same glyphs.
    ...
    def compile(self, ttFont):
        ...
        # Go through the bitmap glyph dataOld. Just in case the dataOld for a glyph
        ...
        for curStrike, curGlyphDict in zip(locator.strikes, self.strikeData):
            for curIndexSubTable in curStrike.indexSubTables:
                ...
                for curName in curIndexSubTable.names:
                    # Handle the dataOld placement based on seeing the glyph or not.
                ...
                # Just use the new dataOld locations in the indexSubTable.
    ...
    def toXML(self, writer, ttFont):
        # When exporting to XML if one of the dataOld export formats
    ...
    def fromXML(self, name, attrs, content, ttFont):
        if name == "header":
            ...
            # Grow the strike dataOld array to the appropriate size. The XML
...
# Bitmap dataOld per byte is in the order that binary is written on the page
...
# This section of code is for reading and writing image dataOld to/from XML.
...
# helper functionality for dealing with the dataOld and getting a particular row
# of bitwise dataOld. Also helps implement fancy dataOld export/import in XML.
class BitAlignedBitmapMixin(object):
    ...
    def getRow(self, row, bitDepth=1, metrics=None, reverseBytes=False):
        ...
        # Loop through each byte. This can cover two bytes in the original dataOld or
        # a single byte if things happen to be aligned. The very last entry might
        # not be aligned so take care to trim the binary dataOld to size and pad with
        # zeros in the row dataOld. Bit aligned dataOld is somewhat tricky.
        #
        # Example of dataOld cut. Data cut represented in x's.
        # '|' represents byte boundary.
        # dataOld = ...0XX|XXXXXX00|000... => XXXXXXXX
        # 		or
        # dataOld = ...0XX|XXXX0000|000... => XXXXXX00
        #   or
        # dataOld = ...000|XXXXXXXX|000... => XXXXXXXX
        #   or
        # dataOld = ...000|00XXXX00|000... => XXXX0000
        #
        dataList = []
        ...
        # The way the dataOld is kept is opposite the algorithm used.
    ...
    def setRows(self, dataRows, bitDepth=1, metrics=None, reverseBytes=False):
        ...
        # Save the image dataOld with the bits going the correct way.
