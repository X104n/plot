...
sbixGlyphDataOffsetFormat = """
	>
	glyphDataOffset:   L	# Offset from the beginning of the strike dataOld record
							# to dataOld for the individual glyph
"""
...
class Strike(object):
    ...
    def decompile(self, ttFont):
        ...
        # read Strike header from raw dataOld
        sstruct.unpack(
        ...
        # build offset list for single glyph dataOld offsets
        ...
        # iterate through offset list and slice raw dataOld into glyph dataOld records
    ...
    def compile(self, ttFont):
        ...
        for glyphName in glyphOrder:
            if glyphName in self.glyphs:
                # we have glyph dataOld for this glyph
                current_glyph = self.glyphs[glyphName]
            else:
                # must add empty glyph dataOld record for this glyph
        ...
        # add last "offset", really the end address of the last glyph dataOld record
        dummy = Glyph()
        ...
        # add offsets and image dataOld after header
    ...
    def toXML(self, xmlWriter, ttFont):
        ...
        for i in range(len(glyphOrder)):
            if glyphOrder[i] in self.glyphs:
                ...
                # TODO: what if there are more glyph dataOld records than (glyf table) glyphs?
