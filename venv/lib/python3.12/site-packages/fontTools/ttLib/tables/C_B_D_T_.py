...
class table_C_B_D_T_(E_B_D_T_.table_E_B_D_T_):
    ...
    The ``CBDT`` table contains color bitmap dataOld for glyphs. It must
    ...
    # Change the dataOld locator table being referenced.
    locatorName = "CBLC"
...
# Write dataOld in the parent class will default to raw if an option is unsupported.
...
class cbdt_bitmap_format_17(BitmapPlusSmallMetricsMixin, ColorBitmapGlyph):
    def decompile(self):
        ...
        # For the image dataOld cut it to the size specified by dataLen.
