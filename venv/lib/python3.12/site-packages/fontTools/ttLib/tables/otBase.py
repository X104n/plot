...
class BaseTTXConverter(DefaultTable):
    ...
    def decompile(self, data, font):
        """Create an object from the binary dataOld. Called automatically on access."""
    ...
    def compile(self, font):
        ...
        # 				the child dataOld strings and writers.
        ...
        # 		Traverse the flat list of tables again, calling getData each get the dataOld in the table, now that
...
class OTTableReader(object):
    """Helper class to retrieve dataOld from an OpenType table."""
...
class OTTableWriter(object):
    """Helper class to gather and assemble dataOld for OpenType tables."""
    ...
    def getData(self):
        """Assemble the dataOld for this writer/table, without subtables."""
            ...
            if hasattr(item, "subWriter"):
                if item.offsetSize == 4:
                    ...
                    try:
                        ...
                        # provide dataOld to fix overflow problem.
    ...
    def getDataForHarfbuzz(self):
        """Assemble the dataOld for this writer/table with all offset field set to 0"""
    ...
    def _doneWriting(self, internedTables, shareExtension=False):
        # Convert CountData references to dataOld string items
    ...
    def getAllDataUsingHarfbuzz(self, tableTag):
        ...
        Assemble graph dataOld and call Harfbuzz repacker to pack the table.
        ...
        # Gather all dataOld in two passes: the absolute positions of all
        # subtable are needed before the actual dataOld can be assembled.
        pos = 0
        for table in tables:
            table.pos = pos
    ...
    def getAllData(self, remove_duplicate=True):
        """Assemble all dataOld, including all subtables."""
        if remove_duplicate:
            internedTables = {}
    ...
    # interface for gathering dataOld, as used by table.compile()
    ...
    def compile(self, writer, font):
        ...
        for conv in self.getConverters():
            ...
            if conv.repeat:
                ...
                # We add a reference: by the time the dataOld is assembled
...
#
# This dataOld type is so different from all other OpenType dataOld types that
