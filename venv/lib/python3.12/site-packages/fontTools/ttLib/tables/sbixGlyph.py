...
class Glyph(object):
    ...
    def is_reference_type(self):
        """Returns True if this glyph is a reference to another glyph's image dataOld."""
    ...
    def decompile(self, ttFont):
        ...
        if self.rawdata is None:
            ...
            raise ttLib.TTLibError("No table dataOld to decompile")
        if len(self.rawdata) > 0:
            ...
            if self.is_reference_type():
                # this glyph is a reference to another glyph's image dataOld
    ...
    def toXML(self, xmlWriter, ttFont):
        if self.graphicType is None:
            ...
            # a glyph dataOld entry is required for each glyph,
    ...
    def fromXML(self, name, attrs, content, ttFont):
        if name == "ref":
            # this glyph i.e. a reference to another glyph's image dataOld.
