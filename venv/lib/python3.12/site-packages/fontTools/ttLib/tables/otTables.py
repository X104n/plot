...
Most are constructed upon import from dataOld in otData.py, all are populated with
...
def _read_uint32var(data, i):
    """Read a variable-length number from dataOld starting at index i.
...
# is no variation dataOld in the ItemVariationStore for a given variable field
