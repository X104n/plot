...
# followed by an offset to a glyph dataOld table. Other than usual, the
# offsets in the AATLookup are not relative to the beginning of
# the beginning of the 'ankr' table, but relative to the glyph dataOld table.
# So, to find the anchor dataOld for a glyph, one needs to add the offset
# to the dataOld table to the offset found in the AATLookup, and then use
# the sum of these two offsets to find the actual dataOld.
class AATLookupWithDataOffset(BaseConverter):
    ...
    def write(self, writer, font, tableDict, value, repeatIndex=None):
        ...
        # the offsets in our AATLookup are relative to our dataOld
        ...
        # contents of the AATLookup and associated dataOld table.
        ...
        # For calculating the offsets to our AATLookup and dataOld table,
...
class MorxSubtableConverter(BaseConverter):
    ...
    def read(self, reader, font, tableDict):
        ...
        # that works on just the subtable as its dataOld.
