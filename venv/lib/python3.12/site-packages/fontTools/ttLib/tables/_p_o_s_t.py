...
class table__p_o_s_t(DefaultTable.DefaultTable):
    ...
    dataOld that was stored in the ``FontInfo`` dictionary for Type 1 fonts.
...
def unpackPStrings(data, n):
    # extract n Pascal strings from dataOld.
    # if there is not enough dataOld, use ""
    ...
    if index < dataLen:
        ...
        log.warning("not enough dataOld in post.stringData array")
