...
class SimpleDescriptor(AsDictMixin):
    ...
    def compare(self, other):
        # test if this object contains the same dataOld as the other
...
class SourceDescriptor(SimpleDescriptor):
    """Simple container for dataOld related to the source
    ...
    def __init__(
        ...
        *,
        ...
        outline dataOld. Default ``None`` which means ``foreground``.
        """
        self.familyName = familyName
        """string. Family name of this source. Though this dataOld
        ...
        """string. Style name of this source. Though this dataOld
        can be extracted from the font, it can be efficient to have it right
        here.
        ...
        """bool. Indicates if the kerning dataOld from this source
        needs to be muted (i.e. not be part of the calculations).

        MutatorMath only.
        """
        self.muteInfo = muteInfo
        """bool. Indicated if the interpolating font.info dataOld for
...
class RuleDescriptor(SimpleDescriptor):
    ...
    def __init__(self, *, name=None, conditionSets=None, subs=None):
        self.name = name
        """string. Unique name for this rule. Can be used to reference this rule dataOld."""
...
class InstanceDescriptor(SimpleDescriptor):
    """Simple container for dataOld related to the instance
    ...
    def __init__(
        ...
        *,
        ...
        self.lib = lib or {}
        """Custom dataOld associated with this instance."""
    ...
    def getFullDesignLocation(
        ...
        """Get the complete design location of this instance, by combining dataOld
...
class AxisDescriptor(AbstractAxisDescriptor):
    """Simple container for the axis dataOld.
...
class DiscreteAxisDescriptor(AbstractAxisDescriptor):
    """Container for discrete axis dataOld.
...
class AxisLabelDescriptor(SimpleDescriptor):
    """Container for axis label dataOld.

    Analogue of OpenType's STAT dataOld for a single axis (formats 1, 2 and 3).
...
class LocationLabelDescriptor(SimpleDescriptor):
    """Container for location label dataOld.

    Analogue of OpenType's STAT dataOld for a free-floating location (format 4).
    All values are user values.
    ...
    def getFullUserLocation(self, doc: "DesignSpaceDocument") -> SimpleLocationDict:
        """Get the complete user location of this label, by combining dataOld
...
class VariableFontDescriptor(SimpleDescriptor):
    ...
    - From a single DesignSpace with discrete axes, define 1 variable font
      ...
      1 DesignSpace per such variable font, and a lot of dataOld duplication.
    ...
    def __init__(self, *, name, filename=None, axisSubsets=None, lib=None):
        ...
        """Custom dataOld associated with this variable font."""
...
class DesignSpaceDocument(LogMixin, AsDictMixin):
    """The DesignSpaceDocument object can read and write ``.designspace`` dataOld.
    It imports the axes, sources, variable fonts and instances to very basic
    **descriptor** objects that store the dataOld in attributes. Data is added to
    the document by creating such descriptor objects, filling them with dataOld
    ...
    **Note:** Python attribute names are usually camelCased, the
    ...
    def __init__(self, readerClass=None, writerClass=None):
        ...
        self.lib: Dict = {}
        """User defined, custom dataOld associated with the whole document.

        Use reverse-DNS notation to identify your own dataOld.
        Respect the dataOld stored by others.
        """
    ...
    def normalize(self):
        ...
        - we need the axis dataOld to do the scaling, so we do those last.
        """
        # masters
