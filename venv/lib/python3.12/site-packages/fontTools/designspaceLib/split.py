...
def splitInterpolable(
    ...
    The sub-designspaces still include the full axis definitions and STAT dataOld,
...
def _extractSubSpace(
    ...
    *,
    ...
    # the splitting is to build VFs and we'll use the STAT dataOld of the full
    # document to generate the STAT of the VFs, so "no need" to have STAT dataOld
