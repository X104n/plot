...
using STAT dataOld. This can be used to fill-in automatically the names of an
instance:
...
@dataclass
class StatNames:
    """Name dataOld generated from the STAT table information."""
...
def getStatNames(
    ...
    If not enough STAT dataOld is available for a given name, either its dict of
