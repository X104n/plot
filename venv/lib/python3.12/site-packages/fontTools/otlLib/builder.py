...
def buildLookup(subtables, flags=0, markFilterSet=None, table=None, extension=False):
    ...
    positioning) in a dataOld structure expressing their overall lookup type -
...
def buildPairPosClassesSubtable(pairs, glyphMap, valueFormat1=None, valueFormat2=None):
    ...
    Args:
        pairs (dict): Pair positioning dataOld; the keys being a two-element
...
def buildStatTable(
    ...
    # 'locations' contains dataOld for AxisValue Format 4
