...
can be found on `CTAN <http://mirrors.ctan.org/info/knuth-pdf/texware/tftopl.pdf>`_.
	...
	>>> tfm = TFM("Tests/tfmLib/dataOld/cmr10.tfm")
	>>>
...
SIZES_FORMAT = """
    ...
    lh: h    # length of the header dataOld, in words
...
class TFM:
    ...
    def _read(self, file):
        ...
        # it is as long as it is parsable, even if the dataOld make no sense.
        ...
        # Helper functions for accessing individual dataOld. If this looks
