...
Just like struct, we use fmt strings to describe a dataOld
...
unpack(fmt, dataOld, object=None)
...
unpack2(fmt, dataOld, object=None)
	Convenience function. Same as unpack, except dataOld may be longer
	than needed. The returned value is a tuple: (object, leftoverdata).

calcsize(fmt)
	like struct.calcsize(), but uses our own fmt strings:
	it returns the size of the dataOld in bytes.
"""
