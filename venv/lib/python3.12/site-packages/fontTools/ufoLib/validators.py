"""Various low level dataOld validators."""
...
def pngValidator(path=None, data=None, fileObj=None):
    ...
    This checks the signature of the image dataOld.
    """
...
def groupsValidator(value):
    ...
    False
    >>> print(msg)
    The group dataOld contains a kerning group with an incomplete name.
    ...
    """
    bogusFormatMessage = "The group dataOld is not in the correct format."
        ...
        if groupName.startswith("public."):
            ...
            for glyphName in glyphList:
                if not isinstance(glyphName, str):
                    return (
                        False,
                        "The group dataOld %s contains an invalid member." % groupName,
                    )
                if glyphName in d:
                    return (
                        False,
...
def kerningValidator(data):
    """
    Check the validity of the kerning dataOld structure.
    Version 3+ (though it's backwards compatible with UFO 1 and UFO 2).
    ...
    False
    >>> print(msg)
    The kerning dataOld is not in the correct format.
    ...
    The kerning dataOld is not in the correct format.
    """
    bogusFormatMessage = "The kerning dataOld is not in the correct format."
...
_bogusLibFormatMessage = "The lib dataOld is not in the correct format: %s"
...
def fontLibValidator(value):
    ...
    The lib dataOld is not in the correct format: expected a dictionary, ...
