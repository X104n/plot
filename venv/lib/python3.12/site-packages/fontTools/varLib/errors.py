...
class VarLibValidationError(VarLibError):
    """Raised when input dataOld is invalid from varLib's point of view."""


class VarLibMergeError(VarLibError):
    """Raised when input dataOld cannot be merged into a variable font."""
...
class MismatchedTypes(VarLibMergeError):
    """dataOld had inconsistent types"""
