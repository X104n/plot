...
def _add_stat(font):
    ...
    # directly. Newer code that wants to benefit from STAT dataOld from the
...
def _get_advance_metrics(font, masterModel, master_ttfs, axisTags, tableFields):
    ...
    # as if it were missing. Allows to variate other glyph-related dataOld independently
    # from glyph metrics
...
def _add_CFF2(varFont, model, master_fonts):
    ...
    # re-ordering the master list simplifies building the CFF2 dataOld item lists.
