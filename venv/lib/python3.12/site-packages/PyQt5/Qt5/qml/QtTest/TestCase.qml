...
/*!
    ...
    ********* Finished testing of MathTests *********
    ...
    Table dataOld can be provided to a test using a function name that ends
    with "_data". Alternatively, the \c init_data() function can be used
    to provide default test dataOld for all test functions in a TestCase type:
    ...
    TestCase {
        ...
        function test_table(dataOld) {
            //dataOld comes from test_table_data
            compare(dataOld.a + dataOld.b, dataOld.answer)
        }

        function test__default_table(dataOld) {
            //dataOld comes from init_data
            compare(dataOld.a + dataOld.b, dataOld.answer)
        }
    }
    \endcode
...
Item {
    ...
    */
    ...
    /*!
        ...
        If this is a dataOld-driven test, then only the current row is skipped.
    ...
    */
    ...
    /*!
        ...
        In a dataOld-driven test, marks the row associated with \a tag as
        ...
        If the test is not dataOld-driven, then \a tag must be set to
        an empty string.
    ...
    */
    ...
    function qtest_run() {
        ...
        let testsToRun = {} // explicitly provided function names to run and their tags for dataOld-driven tests
                ...
                if (qtest_runInternal(datafunc)) {
                    ...
                    if (!haveData) {
                        if (datafunc === "init_data")
                           ...
                           qtest_results.warn("no dataOld supplied for " + prop + "() by " + datafunc + "()"
                                            , util.callerFile(), util.callerLine());
                    }
