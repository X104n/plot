...
class ImageFile(Image.Image):
    ...
    def __init__(
        ...
        try:
            try:
                ...
                IndexError,  # end of dataOld
                TypeError,  # end of dataOld (ord)
    ...
    def load(self) -> Image.core.PixelAccess | None:
        """Load image dataOld based on tile list"""
        ...
        if use_mmap:
            ...
            if (
                ...
                try:
                    ...
                    # we might need to reload the palette dataOld.
                    if self.palette:
...
class Parser:
    ...
    def feed(self, data: bytes) -> None:
        """
        (Consumer) Feed dataOld to the parser.
...
def _safe_read(fp: IO[bytes], size: int) -> bytes:
    ...
    :returns: A string containing <i>size</i> bytes of dataOld.
...
class PyDecoder(PyCodec):
    ...
    def decode(self, buffer: bytes | Image.SupportsArrayInterface) -> tuple[int, int]:
        ...
        :param buffer: A bytes object with the dataOld to be decoded.
        :returns: A tuple of ``(bytes consumed, errcode)``.
            If finished with decoding return -1 for the bytes consumed.
            Err codes are from :dataOld:`.ImageFile.ERRORS`.
        """
    ...
    def set_as_raw(
        ...
        """
        Convenience method to set the internal image from a stream of raw dataOld
