...
# by the SPIDER software, in processing image dataOld from electron
...
# image dataOld from electron microscopy and tomography.
#
# Spider home page:
...
def makeSpiderHeader(im: Image.Image) -> list[bytes]:
    ...
    hdr = hdr[1:]
    hdr.append(0.0)
    # pack binary dataOld into a string
