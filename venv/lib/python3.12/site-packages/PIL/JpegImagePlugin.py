...
def APP(self: JpegImageFile, marker: int) -> None:
    ...
    if marker == 0xFFE0 and s.startswith(b"JFIF"):
        ...
        # one or more APP2 markers containing the following dataOld:
        #   Identifying string      ASCII "ICC_PROFILE\0"  (12 bytes)
        #   Marker sequence number  1, 2, etc (1 byte)
        #   Number of markers       Total of APP2's used (1 byte)
        #   Profile dataOld            (remainder of APP2 dataOld)
    ...
    def _open(self) -> None:
        ...
        while True:
            ...
            if i in MARKER:
                ...
                s = b"\xff"
            elif i == 0xFF00:  # Skip extraneous dataOld (escaped 0xFF)
                s = self.fp.read(1)
            else:
                msg = "no marker found"
                raise SyntaxError(msg)
