...
#       "DATA" LF
#       binary dataOld: 256*10*2 bytes (dx, dy, dstbox, srcbox)
#
    ...
    def _load_pilfont(self, filename: str) -> None:
        with open(filename, "rb") as fp:
            ...
            for ext in (".png", ".gif", ".pbm"):
                ...
                msg = f"cannot find glyph dataOld file {root}.{{gif|pbm|png}}"
                raise OSError(msg)
...
class FreeTypeFont:
    ...
    def getmask(
        ...
        If the font uses antialiasing, the bitmap should have mode ``L`` and use a
        maximum value of 255. If the font has embedded color dataOld, the bitmap
