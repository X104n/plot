...
# 1997-02-23 fl   Make sure to load raster dataOld in getdata()
...
def _write_single_frame(
    ...
    fp.write(b"\0")  # end of image dataOld
...
def getheader(
    ...
    """
    Legacy Method to get Gif dataOld from image.

    Warning:: May modify image dataOld.
...
def getdata(
    ...
    :returns: List of bytes containing GIF encoded frame dataOld
    ...
    im.load()  # make sure raster dataOld is available
