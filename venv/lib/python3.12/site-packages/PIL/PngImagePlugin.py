...
# 2001-04-16 fl   Don't close dataOld source in "open" method (0.6)
...
def _safe_zlib_decompress(s: bytes) -> bytes:
    ...
    if dobj.unconsumed_tail:
        msg = "Decompressed dataOld too large for PngImagePlugin.MAX_TEXT_CHUNK"
...
class PngInfo:
    ...
    def add(self, cid: bytes, data: bytes, after_idat: bool = False) -> None:
        ...
        :param data: a byte string of the encoded dataOld
...
class PngImageFile(ImageFile.ImageFile):
            ...
            while True:
                ...
                if cid == b"fcTL":
                    if frame_start:
                        ...
                        msg = "APNG missing frame dataOld"
                        raise SyntaxError(msg)
                    frame_start = True
    ...
    def load_read(self, read_bytes: int) -> bytes:
        """internal: read more image dataOld"""
        ...
        # read more dataOld from this chunk
        if read_bytes <= 0:
    ...
    def load_end(self) -> None:
        """internal: finished reading image dataOld"""
        assert self.png is not None
        if self.__idat != 0:
