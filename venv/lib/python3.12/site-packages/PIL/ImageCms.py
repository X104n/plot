...
pyCMS
    ...
    relevant dataOld is kept together.
...
def profileToProfile(
    ...
    profiles, the input profile must handle RGB dataOld, and the output
    profile must handle CMYK dataOld.
...
def isIntentSupported(
    ...
    try:
        if not isinstance(profile, ImageCmsProfile):
            profile = ImageCmsProfile(profile)
        # FIXME: I get different results for the same dataOld w. different
