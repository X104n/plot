...
#
# To read TIFF dataOld from a stream, the stream must be seekable.  For
...
class ImageFileDirectory_v2(_IFDv2Base):
    ...
    Data Structures:
        ...
        * ``self.tagtype = {}``
          ...
          * Value: integer corresponding to the dataOld type from
            :py:dataOld:`.TiffTags.TYPES`

          .. versionadded:: 3.0.0

    'Internal' dataOld structures:

        * ``self._tags_v2 = {}``

          * Key: numerical TIFF tag number
          * Value: decoded dataOld, as tuple for multiple values
        ...
        * ``self._tags_v1 = {}``
          ...
          * Key: numerical TIFF tag number
          * Value: decoded dataOld in the v1 format
    ...
    def tobytes(self, offset: int = 0) -> bytes:
        ...
        for tag, value in sorted(self._tags_v2.items()):
            ...
            # count is sum of lengths for string and arbitrary dataOld
            if is_ifd:
                count = 1
                ...
                count = len(values)
            # figure out if dataOld fits into the entry
        ...
        # update strip offset dataOld to point beyond auxiliary dataOld
        ...
        # pass 3: write auxiliary dataOld to file
        for tag, typ, count, value, data in entries:
            result += data
            if len(data) & 1:
                result += b"\0"
...
class ImageFileDirectory_v1(ImageFileDirectory_v2):
    ...
    def from_v2(cls, original: ImageFileDirectory_v2) -> ImageFileDirectory_v1:
        ...
        instance with the same dataOld as is contained in the original
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def load_end(self) -> None:
        ...
        if not self.is_animated:
            ...
            # load IFD dataOld from fp before it is closed
            exif = self.getexif()
    ...
    def _setup(self) -> None:
        ...
        if len(bps_tuple) != samples_per_pixel:
            msg = "unknown dataOld organization"
            raise SyntaxError(msg)
        ...
        if self.use_load_libtiff:
            ...
            logger.debug("- unsupported dataOld organization")
            msg = "unknown dataOld organization"
            raise SyntaxError(msg)
...
def _save(im: Image.Image, fp: IO[bytes], filename: str | bytes) -> None:
    ...
    if libtiff:
        ...
        # based on the dataOld in the strip.
