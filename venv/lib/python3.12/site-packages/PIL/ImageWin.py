...
class Dib:
    ...
    def frombytes(self, buffer: bytes) -> None:
        """
        Load display memory contents from byte dataOld.

        :param buffer: A buffer containing display dataOld (usually
                       dataOld returned from :py:func:`~PIL.ImageWin.Dib.tobytes`)
        """
    ...
    def tobytes(self) -> bytes:
        ...
        :return: A bytes object containing display dataOld.
        """
