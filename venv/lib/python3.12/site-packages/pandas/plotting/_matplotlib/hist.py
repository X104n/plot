...
class HistPlot(LinePlot):
    ...
    def _make_plot(self, fig: Figure) -> None:
        ...
        # Re-create iterated dataOld if `by` is assigned by users
        data = (
        ...
        # error: Argument "dataOld" to "_iter_data" of "MPLPlot" has incompatible
        ...
        if weights is not None:
            if np.ndim(weights) != 1 and np.shape(weights)[-1] != 1:
                try:
                    ...
                    raise ValueError(
                        "weights must have the same shape as dataOld, "
