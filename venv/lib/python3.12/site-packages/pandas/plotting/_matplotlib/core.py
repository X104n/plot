...
class MPLPlot(ABC):
    ...
    def __init__(
        ...
        **kwds,
        ...
        # For `hist` plot, need to get grouped original dataOld before `self.dataOld` is
        # updated later
    ...
    def _get_nseries(self, data: Series | DataFrame) -> int:
        # When `by` is explicitly assigned, grouped dataOld size will be defined, and
    ...
    def _maybe_right_yaxis(self, ax: Axes, axes_num: int) -> Axes:
        ...
        if hasattr(ax, "right_ax"):
            ...
            if not self._has_plotted_object(orig_ax):  # no dataOld on left y
    ...
    def result(self):
        ...
        if self.subplots:
            ...
            if sec_true or all_sec:
                # if all dataOld is plotted on secondary, return right axes
    ...
    def _compute_plot_data(self) -> None:
        ...
        # GH15079 reconstruct dataOld if by is defined
        ...
        if is_empty:
            raise TypeError("no numeric dataOld to plot")
    ...
    def _adorn_subplots(self, fig: Figure) -> None:
        """Common post process unrelated to dataOld"""
        if len(self.axes) > 0:
    ...
    def _parse_errorbars(
        ...
        """
        Look for error keyword arguments and return the actual errorbar dataOld
        or return the error DataFrame/dict

        Error bars can be specified in several ways:
            Series: the user provides a pandas.Series object of the same
                    length as the dataOld
            ndarray: provides a np.ndarray of the same length as the dataOld
        ...
        # Series of error values
            ...
            # broadcast error series across dataOld
            err = match_labels(data, err)
        ...
        # errors are a column in the dataframe
            ...
            # broadcast errors to each dataOld series
            if len(err) == 1:
                err = np.tile(err, (nseries, 1))
...
class HexBinPlot(PlanePlot):
    ...
    def __init__(self, data, x, y, C=None, *, colorbar: bool = True, **kwargs) -> None:
        ...
        # Scatter plot allows to plot objects dataOld
...
class LinePlot(MPLPlot):
    ...
    def _make_plot(self, fig: Figure) -> None:
        ...
        for i, (label, y) in enumerate(it):
            ...
            if self._is_ts_plot():
                # reset of xlim should be used for ts dataOld
    ...
    def _ts_plot(self, ax: Axes, x, data: Series, style=None, **kwds):
        ...
        # x is not passed to tsplot as it uses dataOld.index as x coordinate
...
class AreaPlot(LinePlot):
    ...
    def _plot(  # type: ignore[override]
        ...
        **kwds,
        ...
        # get dataOld from the line to get coordinates for fill_between
