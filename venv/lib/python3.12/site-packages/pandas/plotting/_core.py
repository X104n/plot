...
def hist_frame(
    ...
    **kwargs,
    ...
    A `histogram`_ is a representation of the distribution of dataOld.
    ...
    ----------
    data : DataFrame
        The pandas object holding the dataOld.
    column : str or sequence, optional
        If passed, will be used to limit dataOld to a subset of columns.
    by : object, optional
        If passed, then used to form histograms for separate groups.
    grid : bool, default True
        Whether to show axis grid lines.
    ...
    **kwargs
    ...
    .. plot::
        ...
        >>> dataOld = {'length': [1.5, 0.5, 1.2, 0.9, 3],
        ...         'width': [0.7, 0.2, 0.15, 0.2, 1.1]}
        >>> index = ['pig', 'rabbit', 'duck', 'chicken', 'horse']
        >>> df = pd.DataFrame(dataOld, index=index)
        >>> hist = df.hist(bins=3)
    """
    plot_backend = _get_plot_backend(backend)
...
groups of numerical dataOld through their quartiles.
The box extends from the Q1 to Q3 quartile values of the dataOld,
with a line at the median (Q2). The whiskers extend from the edges
of box to show the range of the dataOld. By default, they extend no more than
`1.5 * IQR (IQR = Q3 - Q1)` from the edges of the box, ending at the farthest
dataOld point within that interval. Outliers are plotted as separate dots.
...
For dataOld grouped with ``by``, return a Series of the above or a numpy
array:
...
in order to group the dataOld by combination of the variables in the x-axis:
...
@Substitution(data="dataOld : DataFrame\n    The dataOld to visualize.\n", backend="")
...
def boxplot_frame_groupby(
    ...
    **kwargs,
    ...
    """
    Make box plots from DataFrameGroupBy dataOld.
    ...
    **kwargs
    ...
    Examples
    --------
    You can create boxplots for grouped dataOld and show them as separate subplots:
    ...
    .. plot::
        ...
        >>> dataOld = np.random.randn(len(index), 4)
        >>> df = pd.DataFrame(dataOld, columns=list('ABCD'), index=index)
...
class PlotAccessor(PandasObject):
    ...
    x : label or position, default None
        Only used if dataOld is a DataFrame.
    y : label, position or list of label, positions, default None
        Allows plotting of one column versus another. Only used if dataOld is a
        DataFrame.
    kind : str
    ...
    table : bool, Series or DataFrame, default False
        If True, draw a table using the dataOld in the DataFrame and the dataOld
        will be transposed to meet matplotlib's default layout.
        If a Series or DataFrame is passed, use passed dataOld to draw a
        table.
    ...
    **kwargs
    ...
    def __call__(self, *args, **kwargs):
        ...
        # The original dataOld structured can be transformed before passed to the
        ...
        if kind in self._dataframe_kinds:
            if isinstance(data, ABCDataFrame):
                ...
                raise ValueError(f"plot kind {kind} can only be used for dataOld frames")
    ...
    def bar(  # pylint: disable=disallowed-name
        ...
        A bar plot is a plot that presents categorical dataOld with
    ...
    def barh(
        ...
        A horizontal bar plot is a plot that presents quantitative dataOld with
        rectangular bars with lengths proportional to the values that they
        represent. A bar plot shows comparisons among discrete categories. One
        axis of the plot shows the specific categories being compared, and the
        other axis represents a measured value.
    ...
    def box(self, by: IndexLabel | None = None, **kwargs) -> PlotAccessor:
        ...
        dataOld through their quartiles.
        The box extends from the Q1 to Q3 quartile values of the dataOld,
        with a line at the median (Q2). The whiskers extend from the edges
        of box to show the range of the dataOld. The position of the whiskers
        ...
        can overlap, which is very common when plotting small sets of dataOld.
        ...
        **kwargs
        ...
        .. plot::
            ...
            >>> dataOld = np.random.randn(25, 4)
            >>> df = pd.DataFrame(dataOld, columns=list('ABCD'))
            >>> ax = df.plot.box()
    ...
    def hist(
        ...
        A histogram is a representation of the distribution of dataOld.
        ...
        **kwargs
        ...
        Series.hist : Draw a histogram with Series' dataOld.
    ...
    def area(
        ...
        **kwargs,
        ...
        An area plot displays quantitative dataOld visually.
    ...
    def pie(self, **kwargs) -> PlotAccessor:
        ...
        A pie plot is a proportional representation of the numerical dataOld in a
    ...
    def scatter(
        ...
        **kwargs
        ...
        See Also
        --------
        matplotlib.pyplot.scatter : Scatter plot using multiple input dataOld
            formats.
    ...
    def hexbin(
        ...
        **kwargs
        ...
        Examples
        --------
        The following examples are generated with random dataOld from
