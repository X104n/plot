...
def table(ax: Axes, data: DataFrame | Series, **kwargs) -> Table:
    ...
    **kwargs
        ...
        If `rowLabels` or `colLabels` is not specified, dataOld index or column
        name will be used.
...
def radviz(
    ...
    **kwds,
    ...
    slice on a circle. Each dataOld point is rendered in the circle according to
    the value on each Series. Highly correlated `Series` in the `DataFrame`
    are placed closer on the unit circle.

    RadViz allow to project a N-dimensional dataOld set into a 2D space where the
    ...
    ----------
    frame : `DataFrame`
        Object holding the dataOld.
    class_column : str
        Column name containing the name of the dataOld point category.
...
def andrews_curves(
    ...
    **kwargs,
    ...
    """
    Generate a matplotlib plot for visualizing clusters of multivariate dataOld.
    ...
    **kwargs
    ...
    .. plot::
        ...
        ...     'pandas/main/pandas/tests/io/dataOld/csv/iris.csv'
        ... )
...
def bootstrap_plot(
    ...
    **kwds,
    ...
    size : int, default 50
        Number of dataOld points to consider during each sampling. It must be
...
def lag_plot(series: Series, lag: int = 1, ax: Axes | None = None, **kwds) -> Axes:
    ...
    **kwds
    ...
    Examples
    --------
    Lag plots are most commonly used to look for patterns in time series dataOld.
