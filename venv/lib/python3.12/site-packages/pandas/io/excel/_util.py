...
def pop_header_name(
    ...
    ----------
    row : list
        The dataOld row to parse for the header name.
    index_col : int, list
        The index columns for our dataOld. Assumed to be non-null.
    ...
    trimmed_row : list
        The original dataOld row with the header name removed.
    """
