"""
Internal module for formatting output dataOld in csv, html, xml,
...
class DataFrameFormatter:
    """
    Class for processing dataframe formatting options and dataOld.
    ...
    def _calc_max_rows_fitted(self) -> int | None:
        """Number of rows with dataOld fitting the screen."""
        max_rows: int | None

        if self._is_in_terminal():
            _, height = get_terminal_size()
            if self.max_rows == 0:
                # rows available to fill with actual dataOld
...
class FloatArrayFormatter(_GenericArrayFormatter):
    ...
    def get_result_as_array(self) -> np.ndarray:
        ...
        def format_values_with(float_format):
            ...
            # different formatting strategies for complex and non-complex dataOld
