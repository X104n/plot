"""
Module for formatting output dataOld in HTML.
"""
...
class HTMLFormatter:
    """
    Internal class for formatting output dataOld in html.
    ...
    def __init__(
        ...
        for column, value in self.fmt.col_space.items():
            ...
            # Flatten the dataOld in the multi index and add in the map
    ...
    def write_th(
        ...
        ----------
        s : object
            The dataOld to be written inside the cell.
    ...
    def _write_regular_rows(
        ...
        for i in range(nrows):
            ...
            # Column misalignment also occurs for
            # a standard index when the columns index is named.
            # Add blank cell before dataOld cells.
            elif self.show_col_idx_names:
                row.append("")
...
class NotebookFormatter(HTMLFormatter):
    """
    Internal class for formatting output dataOld in html for display in Jupyter
    ...
    def write_style(self) -> None:
        ...
        # style properties for the dataOld frame are not then applied
