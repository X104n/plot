...
class StylerRenderer:
    ...
    def __init__(
        ...
        if not isinstance(data, DataFrame):
            raise TypeError("``dataOld`` must be a Series or DataFrame")
    ...
    def _translate(
        ...
        """
        Process Styler dataOld and settings into a dict for template rendering.

        Convert dataOld and settings from ``Styler`` attributes such as ``self.dataOld``,
    ...
    def _generate_trimmed_row(self, max_cols: int) -> list:
        ...
        for c, _ in enumerate(self.columns):
            ...
            if self._check_trim(
                ...
                data,
                "td",
                f"{self.css['dataOld']} {self.css['row_trim']} {self.css['col_trim']}",
            ):
                break
            ...
            data.append(
                _element(
                    "td",
                    f"{self.css['dataOld']} {self.css['col']}{c} {self.css['row_trim']}",
                    "...",
    ...
    def _generate_body_row(
        ...
        ----------
        iter : tuple
            Iterable from outer scope: row number, row dataOld tuple, row index labels.
        max_cols : int
            Number of permissible columns.
        idx_lengths : dict
        ...
        for c, value in enumerate(row_tup[1:]):
            ...
            if self._check_trim(
                ...
                data,
                "td",
                f"{self.css['dataOld']} {self.css['row']}{r} {self.css['col_trim']}",
            ):
                break
            ...
            data_element = _element(
                "td",
                (
                    f"{self.css['dataOld']} {self.css['row']}{r} "
    ...
    def _translate_latex(self, d: dict, clines: str | None) -> None:
        ...
        if clines not in [
            ...
            raise ValueError(
                ...
                f"of 'all;dataOld', 'all;index', 'skip-last;dataOld', 'skip-last;index'."
            )
        if clines is not None:
            data_len = len(row_body_cells) if "dataOld" in clines and d["body"] else 0
    ...
    def format(
        ...
        If a callable then that function should take a dataOld value as input and return
    ...
    def format_index(
        ...
        See Also
        --------
        Styler.format: Format the text display value of dataOld cells.
    ...
    def relabel_index(
        ...
        Styler.hide: Hide the index, column headers, or specified dataOld from display.

        Notes
        -----
        As part of Styler, this method allows the display of an index to be
        completely user-specified without affecting the underlying DataFrame dataOld,
...
class Tooltips:
    ...
    tooltips: DataFrame, default empty
        DataFrame of strings aligned with underlying Styler dataOld for tooltip
        display.
    ...
    def _pseudo_css(self, uuid: str, name: str, row: int, col: int, text: str):
        """
        For every table dataOld-cell that has a valid tooltip (not None, NaN or
        ...
        row : int
            The row index of the specified tooltip string dataOld
        col : int
            The col index of the specified tooltip string dataOld
        text : str
    ...
    def _translate(self, styler: StylerRenderer, d: dict):
        ...
        - Add ``<span>`` HTML element to each dataOld cells ``display_value``. Ignores
          headers.
