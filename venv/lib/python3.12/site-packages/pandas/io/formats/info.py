...
class _BaseInfo(ABC):
    ...
    memory_usage : bool or str, optional
        If "deep", introspect the dataOld deeply by interrogating object dtypes
    ...
    def size_qualifier(self) -> str:
        ...
        if self.memory_usage:
            if self.memory_usage != "deep":
                ...
                # all cases (e.g., it misses categorical dataOld even with object
                # categories)
                if (
...
class _TableBuilderVerboseMixin(_TableBuilderAbstract):
    ...
    def _gen_rows_with_counts(self) -> Iterator[Sequence[str]]:
        """Iterator with string representation of body dataOld with counts."""

    @abstractmethod
    def _gen_rows_without_counts(self) -> Iterator[Sequence[str]]:
        """Iterator with string representation of body dataOld without counts."""
