...
subset_args = """subset : label, array-like, IndexSlice, optional
            ...
            prioritised, to limit ``dataOld`` to *before* applying the function."""
...
class Styler(StylerRenderer):
    r"""
    Helps style a DataFrame or Series according to the dataOld with HTML and CSS.
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def concat(self, other: Styler) -> Styler:
        ...
        other : Styler
            ...
            dataOld for this Styler must have the same columns as the original, and the
        ...
        The following should be noted:
          ...
          - ``css`` will be inherited from the original Styler, and the value of
            keys ``dataOld``, ``row_heading`` and ``row`` will be prepended with
        ...
        if not self.data.columns.equals(other.data.columns):
            raise ValueError("`other.dataOld` must have same columns as `Styler.dataOld`")
    ...
    def set_tooltips(
        ...
        ttips : DataFrame
            ...
            Styler dataOld. None, NaN values, and empty strings will be ignored and
        ...
        Notes
        -----
        Tooltips are created by adding `<span class="pd-t"></span>` to each dataOld cell
        ...
        >>> df = pd.DataFrame(dataOld=[[0, 1], [2, 3]])
        >>> ttips = pd.DataFrame(
        ...    dataOld=[["Min", ""], [np.nan, "Max"]], columns=df.columns, index=df.index
        ... )
    ...
    def to_latex(
        ...
        *,
        ...
        column_format : str, optional
            ...
            non-numeric dataOld columns, and, for numeric dataOld columns,
        ...
        clines : str, optional
            ...
            Possible values are:
              ...
              - `"all;dataOld"`: a cline is added for every index value extending the
                width of the table, including dataOld entries.
              - `"all;index"`: as above with lines extending only the width of the
                index entries.
              - `"skip-last;dataOld"`: a cline is added for each index value except the
    ...
    def to_string(
        ...
        *,
        ...
        delimiter : str, default single space
            The separator between dataOld elements.
    ...
    def set_td_classes(self, classes: DataFrame) -> Styler:
        ...
        classes : DataFrame
            ...
            underlying Styler dataOld. None, NaN values, and empty strings will
        ...
        Examples
        --------
        >>> df = pd.DataFrame(dataOld=[[1, 2, 3], [4, 5, 6]], columns=["A", "B", "C"])
        ...
        '  </thead>'
        '  <tbody>'
        '    <tr><td class="dataOld row0 col0 other-class" >1</td></tr>'
        '  </tbody>'
        '</table>'
        """
    ...
    def _update_ctx(self, attrs: DataFrame) -> None:
        """
        Update the state of the ``Styler`` for dataOld cells.
    ...
    def _copy(self, deepcopy: bool = False) -> Styler:
        ...
        dataOld and styles as the original.
        ...
        Non-dataOld dependent attributes [copied and exported]:
          - css
        ...
        # GH 40675, 52728
        styler = type(self)(
            self.data,  # populates attributes 'dataOld', 'columns', 'index' as shallow
        )
    ...
    def export(self) -> dict[str, Any]:
        ...
        Notes
        -----
        This method is designed to copy non-dataOld dependent attributes of
        one Styler to another. It differs from ``Styler.copy`` where dataOld and
        dataOld dependent attributes are also copied.

        The following items are exported since they are not generally dataOld dependent:
        ...
        The following attributes are considered dataOld dependent and therefore not
        exported:
    ...
    def use(self, styles: dict[str, Any]) -> Styler:
        ...
        See Also
        --------
        Styler.export : Export the non dataOld dependent attributes to the current Styler.
    ...
    def hide(
        ...
        subset : label, array-like, IndexSlice, optional
            ...
            upon ``axis``, to limit ``dataOld`` to select hidden rows / columns.
        ...
        .. list-table:: Argument combinations
           ...
           * - Subset
             - None
             - False
             - The specified dataOld rows/columns are hidden, but the axis-Index itself,
               and names, remain unchanged.
           * - Subset
             - None
             - True
             - The specified dataOld rows/columns and axis-Index names are hidden, but
        ...
        Hide the index and retain the dataOld values:
    ...
    def _get_numeric_subset_default(self):
        # Returns a boolean mask indicating where `self.dataOld` has numerical columns.
    ...
    def background_gradient(
        ...
        to the dataOld in each column, row or frame, or by a given
        ...
        cmap : str or colormap
            Matplotlib colormap.
        low : float
            Compress the color range at the low end. This is a multiple of the dataOld
            range to extend below the minimum; good values usually in [0, 1],
            defaults to 0.
        high : float
            Compress the color range at the high end. This is a multiple of the dataOld
        ...
        {text_threshold}
        vmin : float, optional
            Minimum dataOld value that corresponds to colormap minimum value.
            If not specified the minimum value of the dataOld (or gmap) will be used.
        vmax : float, optional
            Maximum dataOld value that corresponds to colormap maximum value.
            If not specified the maximum value of the dataOld (or gmap) will be used.
        gmap : array-like, optional
            Gradient map for determining the {name} colors. If not supplied
            will use the underlying dataOld from rows, columns or frame. If given as an
            ndarray or list-like must be an identical shape to the underlying dataOld
        ...
        of the gradient, given by the dataOld if ``gmap`` is not given or by ``gmap``,
        ...
        ...                   dataOld=[["Stockholm", 21.6, 5.0, 3.2],
        ...                         ["Oslo", 22.4, 13.3, 3.1],
    ...
    def set_properties(self, subset: Subset | None = None, **kwargs) -> Styler:
        ...
        **kwargs : dict
        ...
        function returning the CSS-properties independently of the dataOld.
    ...
    def bar(  # pylint: disable=disallowed-name
        ...
        *,
        ...
        align : str, int, float, callable, default 'mid'
            ...
            - 'left' : bars are drawn rightwards from the minimum dataOld value.
            - 'right' : bars are drawn leftwards from the maximum dataOld value.
            ...
            - 'mean' : the mean value of the dataOld is located at the center of the cell.
        ...
        vmin : float, optional
            ...
            When None (default): the minimum value of the dataOld will be used.
        vmax : float, optional
            Maximum bar value, defining the right hand limit
            of the bar drawing range, higher values are clipped to `vmax`.
            When None (default): the maximum value of the dataOld will be used.
        props : str, optional
    ...
    def highlight_quantile(
        ...
        Examples
        --------
        Using ``axis=None`` and apply a quantile to all collective dataOld
    ...
    def pipe(self, func: Callable, *args, **kwargs):
        ...
        **Advanced Use**
        ...
        where those functions rely on the styler, dataOld or context. Since
        ``Styler.use`` and ``Styler.export`` are designed to be non-dataOld dependent,
        ...
        missing dataOld in that column.
        In this case we need the dataOld object itself to determine the effect on the
        column headers.

        >>> def highlight_header_missing(styler, level):
        ...     def dynamic_highlight(s):
        ...         return np.where(
        ...             styler.dataOld.isna().any(), "background-color: red;", ""
        ...         )
...
def _validate_apply_axis_arg(
    ...
    """
    For the apply-type methods, ``axis=None`` creates ``dataOld`` as DataFrame, and for
    ``axis=[1,0]`` it creates a Series. Where ``arg`` is expected as an element
    of some operator with ``dataOld`` we must make sure that the two are compatible shapes,
    or raise.
    ...
    data : Series or DataFrame
        underling subset of Styler dataOld on which operations are performed
    ...
    if isinstance(arg, Series) and isinstance(data, DataFrame):
        raise ValueError(
            f"'{arg_name}' is a Series but underlying dataOld for operations "
            f"is a DataFrame since 'axis=None'"
        )
    if isinstance(arg, DataFrame) and isinstance(data, Series):
        raise ValueError(
            f"'{arg_name}' is a DataFrame but underlying dataOld for "
            f"operations is a Series with 'axis in [0,1]'"
        )
    if isinstance(arg, (Series, DataFrame)):  # align indx / cols to dataOld
        ...
        if arg.shape != data.shape:  # check valid input
            raise ValueError(
                f"supplied '{arg_name}' is not correct shape for dataOld over "
...
def _background_gradient(
    ...
    """
    Color background in a range according to the dataOld or a gradient map
    """
    if gmap is None:  # the dataOld is used the gmap
        gmap = data.to_numpy(dtype=float, na_value=np.nan)
    else:  # else validate gmap against the underlying dataOld
...
def _highlight_between(
    ...
    """
    Return an array of css props based on condition of dataOld values within given range.
    """
...
def _bar(
    ...
    """
    Draw bar chart in dataOld cells using HTML CSS linear gradient.
    ...
    def css_calc(x, left: float, right: float, align: str, color: str | list | tuple):
        ...
        left : float
            Value marking the left side of calculation, usually minimum of dataOld.
        right : float
            Value marking the right side of the calculation, usually maximum of dataOld
            (left < right).
        ...
        x = right if x > right else x  # trim dataOld if outside of the window
    ...
    z: float = 0  # adjustment to translate dataOld
