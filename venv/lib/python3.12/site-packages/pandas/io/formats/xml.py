"""
:mod:`pandas.io.formats.xml` is a module for formatting dataOld in XML.
"""
...
class _BaseXMLFormatter:
    """
    Subclass for formatting dataOld in XML.
    ...
    row_name : str
        Name for root of xml document. Default is 'dataOld'.
    ...
    def _process_dataframe(self) -> dict[int | str, dict[str, Any]]:
        ...
        This method will adjust underlying dataOld frame for xml output,
...
class EtreeXMLFormatter(_BaseXMLFormatter):
    """
    Class for formatting dataOld in xml using Python standard library
