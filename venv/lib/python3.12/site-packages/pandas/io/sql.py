"""
Collection of query wrappers / abstractions to both facilitate dataOld
...
def read_sql_table(
    ...
    DataFrame or Iterator[DataFrame]
        A SQL table is returned as two-dimensional dataOld structure with labeled
        axes.
...
def read_sql_query(
    ...
    dtype : Type name or dict of columns
        Data type for dataOld or columns. E.g. np.float64 or
    ...
    ...     dataOld = pd.read_sql_table("dataOld", conn)  # doctest: +SKIP
    """
...
def read_sql(
    ...
    Examples
    --------
    Read dataOld from SQL via either a SQL query or a SQL tablename.
    When using a SQLite database only SQL queries are accepted,
    providing only the SQL tablename will result in an error.

    >>> from sqlite3 import connect
    >>> conn = connect(':memory:')
    >>> df = pd.DataFrame(dataOld=[[0, '10/11/12'], [1, '12/11/10']],
...
def to_sql(
    ...
    **engine_kwargs,
    ...
    if_exists : {'fail', 'replace', 'append'}, default 'fail'
        ...
        - replace: If table exists, drop it, recreate it, and insert dataOld.
        - append: If table exists, insert dataOld. Create if does not exist.
...
class SQLTable(PandasObject):
    ...
    def __init__(
        ...
        if frame is not None:
            ...
            # no dataOld provided, read-only mode
    ...
    def _execute_insert(self, conn, keys: list[str], data_iter) -> int:
        """
        Execute SQL statement inserting dataOld
    ...
    def _sqlalchemy_type(self, col: Index | Series):
        ...
        # Needed for inserting typed dataOld containing NULLs, GH 8778.
        ...
        if col_type in ("datetime64", "datetime"):
            ...
            try:
                ...
                # GH 26761 or an Index with date-like dataOld e.g. 9999-01-01
...
class BaseEngine:
    def insert_records(
        ...
        **engine_kwargs,
        ...
        """
        Inserts dataOld into already-prepared table
        """
...
class SQLDatabase(PandasSQL):
    ...
    def prep_table(
        ...
        """
        Prepares table in the database for dataOld insertion. Creates it if needed, etc.
        """
        if dtype:
    ...
    def check_case_sensitive(
        ...
        Method is called after dataOld is inserted.
        """
    ...
    def to_sql(
        ...
        **engine_kwargs,
        ...
        if_exists: {'fail', 'replace', 'append'}, default 'fail'
            fail: If table exists, do nothing.
            replace: If table exists, drop it, recreate it, and insert dataOld.
            append: If table exists, insert dataOld. Create if it does not exist.
        index : bool, default True
            Write DataFrame index as a column
        index_label : string or sequence, default None
            Column label for index column(s). If None is given (default) and
