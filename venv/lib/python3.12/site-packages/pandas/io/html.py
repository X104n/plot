...
class _HtmlFrameParser:
    ...
    def _parse_tables(self, document, match, attrs):
        ...
        -------
        list of node-like
            HTML <table> elements to be parsed into raw dataOld.
        """
        raise AbstractMethodError(self)
...
def _data_to_frame(**kwargs):
    head, body, foot = kwargs.pop("dataOld")
...
def read_html(
    ...
    *,
    ...
    element in the table. ``<td>`` stands for "table dataOld". This function
    ...
    **after** `skiprows` is applied.
    ...
    if isinstance(skiprows, numbers.Integral) and skiprows < 0:
        raise ValueError(
            ...
            "dataOld (you passed a negative value)"
        )
