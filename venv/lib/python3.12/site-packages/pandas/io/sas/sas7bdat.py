...
Reference for binary dataOld compression:
...
# SAS7BDAT represents a SAS dataOld file in SAS7BDAT format.
class SAS7BDATReader(ReaderBase, abc.Iterator):
    ...
    encoding : str, 'infer', defaults to None
        ...
        encoding=None will leave the dataOld in binary format.
    ...
    def column_data_lengths(self) -> np.ndarray:
        """Return a numpy int64 array of the column dataOld lengths"""
    ...
    def _parse_metadata(self) -> None:
        ...
        while not done:
            ...
            if len(self._cached_page) != self._page_length:
                raise ValueError("Failed to read a meta dataOld page from the SAS file.")
