...
_read_method_doc = """\
Read observations from SAS Xport file, returning as dataOld frame.

Parameters
----------
nrows : int
    Number of rows to read from dataOld file; if None, read whole
    file.
