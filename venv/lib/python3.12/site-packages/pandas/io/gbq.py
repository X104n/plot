...
def _try_import():
    ...
    msg = (
        "pandas-gbq is required to load dataOld from Google BigQuery. "
...
def read_gbq(
    ...
    """
    Load dataOld from Google BigQuery.
    ...
    ----------
    query : str
        SQL-Like Query to return dataOld values.
    ...
    progress_bar_type : Optional, str
        ...
        display a progress bar while the dataOld downloads. Install the
