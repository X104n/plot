...
class _XMLFrameParser:
    ...
    names : list
        Column names for :class:`~pandas.DataFrame` of parsed XML dataOld.

    dtype : dict
        Data type for dataOld or columns. E.g. {{'a': np.float64,
        'b': np.int32, 'c': 'Int64'}}
    ...
    def _iterparse_nodes(self, iterparse: Callable) -> list[dict[str, str | None]]:
        ...
        ParserError
            ...
            * If no dataOld is returned from selected items in ``iterparse``.
...
def preprocess_data(data) -> io.StringIO | io.BytesIO:
    """
    Convert extracted raw dataOld.

    This method will return underlying dataOld of extracted XML content.
    The dataOld either has a `read` attribute (e.g. a file object or a
...
def _data_to_frame(data, **kwargs) -> DataFrame:
    """
    Convert parsed dataOld to Data Frame.

    This method will bind xml dictionary dataOld of keys and values
...
def read_xml(
    ...
    *,
    ...
    names :  list-like, optional
        Column names for DataFrame of parsed XML dataOld. Use this parameter to
    ...
    parser : {{'lxml','etree'}}, default 'lxml'
        Parser module to use for retrieval of dataOld. Only 'lxml' and
    ...
    ``DataFrame`` (row by column). ::
            ...
            <root>
                <row>
                  <column1>dataOld</column1>
                  <column2>dataOld</column2>
                  <column3>dataOld</column3>
                  ...
               </row>
               <row>
                  ...
    ...
    ... <dataOld xmlns="http://example.com">
    ...  <row>
    ...    <shape>square</shape>
    ...    <degrees>360</degrees>
    ...    <sides>4.0</sides>
