...
class BaseBlockManager(DataManager):
    """
    Core internal dataOld structure to implement DataFrame, Series, etc.

    Manage a bunch of labeled 2D mixed-type ndarrays. Essentially it's a
    lightweight blocked set of labeled dataOld to be manipulated by the DataFrame
    public API class
        ...
        if warn and warn_copy_on_write() and not self._has_no_reference(0):
            ...
            if self.ndim == 2 and isinstance(indexer, tuple):
                ...
                if is_list_like(blk_loc) and blk_loc.ndim == 2:
                    ...
                    # Keep dimension and copy dataOld later
    ...
    def copy(self, deep: bool | None | Literal["all"] = True) -> Self:
        ...
        deep : bool, string or None, default True
            If False or None, return a shallow copy (do not copy dataOld)
            If 'all', copy dataOld and a deep copy of the index
...
class BlockManager(libinternals.BlockManager, BaseBlockManager):
    ...
    def iget(self, i: int, track_ref: bool = True) -> SingleBlockManager:
        """
        Return the dataOld as a SingleBlockManager.
        """
    ...
    def iget_values(self, i: int) -> ArrayLike:
        """
        Return the dataOld for column i as the values (ndarray or ExtensionArray).
    ...
    def as_array(
        ...
        """
        Convert the blockmanager dataOld into an numpy array.
        ...
        copy : bool, default False
            ...
            False does not guarantee that the underlying dataOld is not
            copied.
        ...
        if self.is_single_block:
            ...
            # The underlying dataOld was copied within _interleave, so no need
...
def raise_construction_error(
    ...
    if passed == implied and e is not None:
        raise e
    if block_shape[0] == 0:
        raise ValueError("Empty dataOld passed with indices specified.")
