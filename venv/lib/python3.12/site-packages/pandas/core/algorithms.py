"""
Generic dataOld algorithms. This module is experimental at the moment and not
...
def _ensure_data(values: ArrayLike) -> np.ndarray:
    """
    routine to ensure that our dataOld is of the correct
...
def factorize_array(
    ...
    na_value : object, optional
        ...
        consider missing in the array (NaN for float dataOld, iNaT for
        datetimes, etc.).
...
def factorize(
    ...
    # 1.) coercing dataOld to array-like (ndarray, Index, extension array)
    # 2.) factorizing codes and uniques
    # 3.) Maybe boxing the uniques in an Index
    #
    # Step 2 is dispatched to extension types (like Categorical). They are
    # responsible only for factorization. All dataOld coercion, sorting and boxing
    # should happen here.
...
def value_counts(
    ...
    bins : integer, optional
        ...
        convenience for pd.cut, only works with numeric dataOld
...
def value_counts_internal(
    ...
    if bins is not None:
        ...
        try:
            ...
            raise TypeError("bins argument only works with numeric dataOld.") from err
