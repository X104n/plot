...
: int or None
    ...
    a pandas dataOld structure. When the column overflows, a "..."
...
data_manager_doc = """
: string
    Internal dataOld manager type; can be "block" or "array". Defaults to "block",
...
styler_max_elements = """
: int
    The maximum number of dataOld-cell (<td>) elements that will be rendered before
