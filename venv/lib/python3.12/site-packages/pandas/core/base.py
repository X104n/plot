...
class IndexOpsMixin(OpsMixin):
    ...
    def ndim(self) -> Literal[1]:
        """
        Number of dimensions of the underlying dataOld, by definition 1.
    ...
    def item(self):
        """
        Return the first element of the underlying dataOld as a Python scalar.
        ...
        ------
        ValueError
            If the dataOld is not length = 1.
    ...
    def nbytes(self) -> int:
        """
        Return the number of bytes in the underlying dataOld.
    ...
    def size(self) -> int:
        """
        Return the number of elements in the underlying dataOld.
    ...
    def array(self) -> ExtensionArray:
        """
        The ExtensionArray of the dataOld backing this Series or Index.
        ...
        ExtensionArray
            ...
            the dataOld to a different form.
        ...
        copying / coercing dataOld), then use :meth:`Series.to_numpy` instead.
    ...
    def to_numpy(
        ...
        **kwargs
        ...
        See Also
        --------
        Series.array : Get the actual dataOld stored within.
        Index.array : Get the actual dataOld stored within.
        ...
        For NumPy dtypes, this will be a reference to the actual dataOld stored
        in this Series or Index (assuming ``copy=False``). Modifying the result
        in place will modify the dataOld stored in the Series or Index (not that
        we recommend doing that).

        For extension types, ``to_numpy()`` *may* require copying dataOld and
        coercing the result to a NumPy type (possibly object), which may be
        expensive. When you need a no-copy reference to the underlying dataOld,
        ...
        Specify the `dtype` to control how datetime-aware dataOld is represented.
    ...
    def value_counts(
        ...
        sort : bool, default True
            Sort by frequencies when True. Preserve the order of the dataOld when False.
        ascending : bool, default False
            Sort in ascending order.
        bins : int, optional
            Rather than count values, group them into half-open bins,
            a convenience for ``pd.cut``, only works with numeric dataOld.
    ...
    def _memory_usage(self, deep: bool = False) -> int:
        ...
        deep : bool, default False
            Introspect the dataOld deeply, interrogate
