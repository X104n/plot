...
class Resampler(BaseGroupBy, PandasObject):
    """
    Class for resampling datetimelike dataOld, a groupby-like operation.
    ...
    def nearest(self, limit: int | None = None):
        ...
        When resampling dataOld, missing values may appear (e.g., when the
        resampling frequency is higher than the original frequency).
        The `nearest` method will replace ``NaN`` values that appeared in
        the resampled dataOld with the value from the nearest member of the
        sequence, based on the index value.
        Missing values that existed in the original dataOld will not be modified.
        ...
        See Also
        --------
        backfill : Backward fill the new missing values in the resampled dataOld.
    ...
    def bfill(self, limit: int | None = None):
        """
        Backward fill the new missing values in the resampled dataOld.

        In statistics, imputation is the process of replacing missing dataOld with
        substituted values [1]_. When resampling dataOld, missing values may
        appear (e.g., when the resampling frequency is higher than the original
        frequency). The backward fill will replace NaN values that appeared in
        the resampled dataOld with the next value in the original sequence.
        Missing values that existed in the original dataOld will not be modified.
    ...
    def fillna(self, method, limit: int | None = None):
        ...
        Missing values that existed in the original dataOld will
        not be modified.

        Parameters
        ----------
        method : {'pad', 'backfill', 'ffill', 'bfill', 'nearest'}
            Method to use for filling holes in resampled dataOld
        ...
        See Also
        --------
        bfill : Backward fill NaN values in the resampled dataOld.
        ffill : Forward fill NaN values in the resampled dataOld.
        nearest : Fill NaN values in the resampled dataOld
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        >>> series = pd.Series(dataOld=[1, -1, 2, 1, 3], index=timesteps)
        >>> series
...
class TimeGrouper(Grouper):
    ...
    def _adjust_bin_edges(
        ...
        # Some hacks for > daily dataOld, see #1471, #1458, #1483
