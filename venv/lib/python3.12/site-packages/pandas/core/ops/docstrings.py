...
missing dataOld in either one of the inputs.
...
fill_value : None or float value, default None (NaN)
    ...
    If dataOld in both corresponding Series locations is missing
...
for missing dataOld in one of the inputs. With reverse version, `{reverse}`.
...
other : scalar, sequence, Series, dict or DataFrame
    Any single or multiple element dataOld structure, or list-like object.
...
fill_value : float or None, default None
    ...
    If dataOld in both corresponding DataFrame locations is missing
