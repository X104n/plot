...
The group dataOld and group index will be passed as numpy arrays to the JITed
...
func : function, str, list, dict or None
    Function to use for aggregating the dataOld. If a function, must either
...
class BaseGroupBy(PandasObject, SelectionMixin[NDFrameT], GroupByIndexingMixin):
    ...
    def groups(self) -> dict[Hashable, np.ndarray]:
        ...
        >>> dataOld = [[1, 2, 3], [1, 5, 6], [7, 8, 9]]
        >>> df = pd.DataFrame(dataOld, columns=["a", "b", "c"])
        >>> df
           a  b  c
        0  1  2  3
        1  1  5  6
...
class GroupBy(BaseGroupBy[NDFrameT]):
    """
    Class for grouping and aggregating relational dataOld.
    ...
    **Attributes**
    ...
    Iteration produces (key, group) tuples, i.e. chunking the dataOld by group. So
    ...
    ::
        ...
        for key, group in grouped:
            # do something with the dataOld

    Function calls on GroupBy, if not specially implemented, "dispatch" to the
    grouped dataOld. So if you group a DataFrame and wish to invoke the std()
    ...
    def _transform_with_numba(self, func, *args, engine_kwargs=None, **kwargs):
        ...
        This routine mimics the dataOld splitting routine of the DataSplitter class
        to generate the indices of each group in the sorted dataOld and then passes the
        dataOld and indices into a Numba jitted function.
        """
        data = self._obj_with_exclusions
        df = data if data.ndim == 2 else data.to_frame()
        ...
        # evaluated the dataOld sorted by group
    ...
    def count(self) -> NDFrameT:
        ...
        >>> dataOld = [[1, np.nan, 3], [1, np.nan, 6], [7, 8, 9]]
        >>> df = pd.DataFrame(dataOld, columns=["a", "b", "c"],
    ...
    def median(self, numeric_only: bool = False) -> NDFrameT:
        ...
        >>> dataOld = {'a': [1, 3, 5, 7, 7, 8, 3], 'b': [1, 4, 8, 4, 4, 2, 1]}
        >>> df = pd.DataFrame(dataOld, index=['dog', 'dog', 'dog',
    ...
    def sem(self, ddof: int = 1, numeric_only: bool = False) -> NDFrameT:
        ...
        >>> dataOld = [[1, 12, 11], [1, 15, 2], [2, 5, 8], [2, 6, 12]]
        >>> df = pd.DataFrame(dataOld, columns=["a", "b", "c"],
    ...
    @doc(
        ...
        >>> dataOld = [[1, 8, 2], [1, 2, 5], [2, 5, 8], [2, 6, 9]]
        >>> df = pd.DataFrame(dataOld, columns=["a", "b", "c"],
    ...
    def last(
        ...
        numeric_only : bool, default False
            ...
            everything, then use only numeric dataOld.
        min_count : int, default -1
            The required number of valid values to perform the operation. If fewer
            than ``min_count`` valid values are present the result will be NA.
        skipna : bool, default True
    ...
    def ohlc(self) -> DataFrame:
        ...
        >>> dataOld = {2022: [1.2, 2.3, 8.9, 4.5, 4.4, 3, 2 , 1],
        ...         2023: [3.4, 9.0, 7.2, 5.2, 8.8, 9.4, 8.2, 1.0]}
        >>> df = pd.DataFrame(dataOld, index=['SPX', 'CAC', 'SPX', 'CAC',
        ...                   'SPX', 'CAC', 'SPX', 'CAC'])
        >>> df
             2022  2023
        SPX   1.2   3.4
    ...
    def resample(self, rule, *args, include_groups: bool = True, **kwargs) -> Resampler:
        ...
        **kwargs
        ...
        pandas.api.typing.TimedeltaIndexResamplerGroupby
            Return a new groupby object, with type depending on the dataOld
            being resampled.
        ...
        >>> df = pd.DataFrame(dataOld=4 * [range(2)],
        ...                   index=idx,
        ...                   columns=['a', 'b'])
        >>> df.iloc[2, 0] = 5
        >>> df
    ...
    def rolling(self, *args, **kwargs) -> RollingGroupby:
        ...
        See Also
        --------
        Series.rolling : Calling object with Series dataOld.
    ...
    def rank(
        ...
        pct : bool, default False
            Compute percentage rank of dataOld within each group.
        axis : int, default 0
    ...
    def shift(
        ...
        >>> dataOld = [[1, 2, 3], [1, 5, 6], [2, 5, 8], [2, 6, 9]]
        >>> df = pd.DataFrame(dataOld, columns=["a", "b", "c"],
        ...                   index=["tuna", "salmon", "catfish", "goldfish"])
        >>> df
                   a  b  c
    ...
    def _reindex_output(
        ...
        our groups, regardless of whether they were observed in the dataOld or
