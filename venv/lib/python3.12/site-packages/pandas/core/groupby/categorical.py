...
def recode_for_groupby(
    ...
    the dataOld. If sort=True, return self.

    This method is needed solely to ensure the categorical index of the
    GroupBy result has categories in the order of appearance in the dataOld
    (GH-8868).
    ...
    if len(all_codes) > len(unique_notnan_codes):
        # GH 13179: All categories need to be present, even if missing from the dataOld
