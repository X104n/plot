...
def __internal_pivot_table(
    ...
    if values_passed:
        ...
        # GH14938 Make sure value labels are in dataOld
        for i in values:
            if i not in data:
                raise KeyError(i)
...
def _add_margins(
    ...
    if not values and isinstance(table, ABCSeries):
        ...
        # one column in the dataOld. Compute grand margin and return it.
...
def crosstab(
    ...
    -------
    DataFrame
        Cross tabulation of the dataOld.

    See Also
    --------
    DataFrame.pivot : Reshape dataOld based on column values.
    ...
    Any input passed containing Categorical dataOld will have **all** of its
    categories included in the cross-tabulation, even if the actual dataOld does
    ...
    Here 'c' and 'f' are not represented in the dataOld and will not be
    shown in the output because dropna is True by default. Set
    dropna=False to preserve categories with no dataOld.
