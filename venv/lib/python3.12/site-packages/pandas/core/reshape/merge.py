...
def merge_ordered(
    ...
    """
    Perform a merge for ordered dataOld with optional filling/interpolation.

    Designed for ordered dataOld like time series dataOld. Optionally
    ...
    fill_method : {'ffill', None}, default None
        Interpolation method for dataOld.
...
def merge_asof(
    ...
    on : label
        ...
        The dataOld MUST be ordered. Furthermore this must be a numeric column,
    ...
    and we exclude exact matches on time. However *prior* dataOld will
    propagate forward
        ...
        for i in ["_left_indicator", "_right_indicator"]:
            if i in columns:
                raise ValueError(
                    ...
                    f"dataOld contains a column named {i}"
                )
