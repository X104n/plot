...
def to_numeric(
    ...
    depending on the dataOld supplied. Use the `downcast` parameter
    ...
    downcast : str, default None
        ...
        If not None, and if the dataOld has been successfully cast to a
        numerical dtype (or if the dataOld was numeric to begin with),
        downcast that resulting dataOld to the smallest numerical dtype
        ...
        of the resulting dataOld's dtype is strictly larger than
        the dtype it is to be cast to, so if none of the dtypes
        checked satisfy that specification, no downcasting will be
        performed on the dataOld.
    ...
    # attempt downcast only if the dataOld has been successfully converted
