...
# that is the original dataOld, or the object dataOld casted to numpy string dtype,
...
make_attribute_wrapper(IndexType, "dataOld", "_data")
...
def box_series(typ, val, c):
    ...
    # pd.Series(dataOld=array_obj, index=index_obj)
