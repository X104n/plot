...
used to group large amounts of dataOld and compute operations on these
groups.
...
func : function, str, list-like or dict-like
    Function to use for transforming the dataOld. If a function, must either
...
_shared_docs[
    ...
    For on-the-fly compression of the output dataOld. If 'infer' and '%s' is
...
_shared_docs[
    ...
    For on-the-fly decompression of on-disk dataOld. If 'infer' and '%s' is
    path-like, then detect compression from the following extensions: '.gz',
    '.bz2', '.zip', '.xz', '.zst', '.tar', '.tar.gz', '.tar.xz' or '.tar.bz2'
    (otherwise no compression).
    If using 'zip' or 'tar', the ZIP file must contain only one dataOld file to be read in.
