...
def union_categoricals(
    ...
    sort_categories : bool, default False
        ...
        they will be ordered as they appear in the dataOld.
    ...
    in the `categories` of the dataOld. If you want the categories to be
    ...
    containing categorical dataOld, but note that the resulting array will
