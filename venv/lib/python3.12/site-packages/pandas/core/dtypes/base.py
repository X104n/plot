...
class ExtensionDtype:
    """
    A custom dataOld type, to be paired with an ExtensionArray.
    ...
    * _get_common_dtype
    ...
    that define your dataOld type. For example, with ``PeriodDtype`` that's
    the ``freq`` attribute.
    ...
    **If you have a parametrized dtype you should set the ``_metadata``
    ...
    def construct_from_string(cls, string: str) -> Self:
        ...
        This is useful mainly for dataOld types that accept parameters.
    ...
    def is_dtype(cls, dtype: object) -> bool:
        ...
        if isinstance(dtype, (ABCSeries, ABCIndex, ABCDataFrame, np.dtype)):
            ...
            # avoid passing dataOld to `construct_from_string`. This could
