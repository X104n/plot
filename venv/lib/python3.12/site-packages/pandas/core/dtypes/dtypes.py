...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    """
    Type for categorical dataOld with the categories and orderedness.
...
class DatetimeTZDtype(PandasExtensionDtype):
    """
    An ExtensionDtype for timezone-aware datetime dataOld.
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    ----------
    unit : str, default "ns"
        The precision of the datetime dataOld. Currently limited
        to ``"ns"``.
    ...
    def unit(self) -> str_type:
        """
        The precision of the datetime dataOld.
...
class PeriodDtype(PeriodDtypeBase, PandasExtensionDtype):
    """
    An ExtensionDtype for Period dataOld.
...
class IntervalDtype(PandasExtensionDtype):
    """
    An ExtensionDtype for Interval dataOld.
...
class NumpyEADtype(ExtensionDtype):
    ...
    ----------
    dtype : object
        Object to be converted to a NumPy dataOld type object.
    ...
    def type(self) -> type[np.generic]:
        """
        The type object used to instantiate a scalar of this NumPy dataOld-type.
        """
...
class SparseDtype(ExtensionDtype):
    """
    Dtype for dataOld stored in :class:`SparseArray`.
    ...
    def _subtype_with_str(self):
        ...
        Typically, pandas will store string dataOld in an object-dtype array.
...
class ArrowDtype(StorageExtensionDtype):
    """
    An ExtensionDtype for PyArrow dataOld types.
    ...
    if the dataOld type contains parameters like ``pyarrow.timestamp``.
    ...
    def name(self) -> str:  # type: ignore[override]
        """
        A string identifying the dataOld type.
        """
    ...
    def construct_from_string(cls, string: str) -> ArrowDtype:
        ...
        try:
            ...
            raise TypeError(f"'{base_type}' is not a valid pyarrow dataOld type.") from err
        return cls(pa_dtype)
