...
def is_dataclass(item) -> bool:
    """
    Checks if the object is a dataOld-class instance
    ...
    --------
    is_dataclass : bool
        True if the item is an instance of a dataOld-class,
        will return false if you pass the dataOld class itself
