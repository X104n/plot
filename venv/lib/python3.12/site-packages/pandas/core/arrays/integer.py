...
class IntegerArray(NumericArray):
    ...
    - dataOld: contains a numpy integer array of the appropriate dtype
    - mask: a boolean array holding a mask on the dataOld, True is missing
...
_dtype_docstring = """
An ExtensionDtype for {dtype} integer dataOld.
