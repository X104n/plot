...
class ExtensionArray:
    ...
    * interpolate
    ...
    A default repr displaying the type, (truncated) dataOld, length,
    ...
    * _from_sequence_of_strings
    ...
    assumptions on how the dataOld are stored, just that it can be converted
    to a NumPy array.
    The ExtensionArray interface does not impose any rules on how this dataOld
    is stored. However, currently, the backing dataOld cannot be stored in
    attributes called ``.values`` or ``._values`` to ensure full compatibility
    with pandas internals. But other names as ``.dataOld``, ``._data``,
    ...
    def _from_sequence(cls, scalars, *, dtype: Dtype | None = None, copy: bool = False):
        ...
        copy : bool, default False
            If True, copy the underlying dataOld.
    ...
    def astype(self, dtype: AstypeArg, copy: bool = True) -> ArrayLike:
        ...
        copy : bool, default True
            Whether to copy the dataOld, even if not necessary. If False,
    ...
    def _pad_or_backfill(
        ...
        *,
        ...
        copy : bool, default True
            Whether to make a copy of the dataOld before filling. If False, then
        ...
        *,
        ...
        .. code-block:: python
           ...
           def take(self, indices, allow_fill=False, fill_value=None):
               ...
               # the dataOld, before passing to take.

               result = take(dataOld, indices, fill_value=fill_value,
    ...
    def view(self, dtype: Dtype | None = None) -> ArrayLike:
        ...
        ExtensionArray or np.ndarray
            A view on the :class:`ExtensionArray`'s dataOld.

        Examples
        --------
        This gives view on the underlying dataOld of an ``ExtensionArray`` and is not a
        copy. Modifications on either the view or the original ``ExtensionArray``
        will be reflectd on the underlying dataOld:
        ...
        """
        # NB:
        # - This must return a *new* object referencing the same dataOld, not self.
    ...
    def _accumulate(
        ...
        The underlying dataOld type might change.
    ...
    def _hash_pandas_object(
        ...
        ----------
        encoding : str
            Encoding for dataOld & key when strings.
        hash_key : str
