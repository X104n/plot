...
class PeriodArray(dtl.DatelikeOps, libperiod.PeriodMixin):  # type: ignore[misc]
    """
    Pandas ExtensionArray for storing Period dataOld.
    ...
    values : Union[PeriodArray, Series[period], ndarray[int], PeriodIndex]
        The dataOld to store. These should be arrays that can be directly
    ...
    PeriodIndex : Immutable Index for period dataOld.
...
def period_array(
    ...
    freq : str, Tick, or Offset
        ...
        to avoid inferring the `freq` from `dataOld`.
    copy : bool, default False
        Whether to ensure a copy of the dataOld is made.
...
def dt64arr_to_periodarr(
    ...
    freq : Optional[Union[str, Tick]]
        Must match the `freq` on the `dataOld` if `dataOld` is a DatetimeIndex
        or Series.
    tz : Optional[tzinfo]
