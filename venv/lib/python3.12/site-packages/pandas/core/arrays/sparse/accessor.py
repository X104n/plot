...
class BaseAccessor:
    _validation_msg = "Can only use the '.sparse' accessor with Sparse dataOld."
...
class SparseAccessor(BaseAccessor, PandasDelegate):
    """
    Accessor for SparseSparse from other sparse matrix dataOld types.
...
class SparseFrameAccessor(BaseAccessor, PandasDelegate):
    """
    DataFrame accessor for sparse dataOld.
    ...
    def density(self) -> float:
        """
        Ratio of non-sparse points to total (dense) dataOld points.
