...
@Appender(
    ...
    % {
        "klass": "IntervalArray",
        "summary": "Pandas array for interval dataOld that are closed on the same side.",
        "name": "",
        "extra_attributes": "",
        "extra_methods": "",
...
class IntervalArray(IntervalMixin, ExtensionArray):
    ...
    def __new__(
        ...
        if isinstance(data, cls):
            ...
            # might need to convert empty or purely na dataOld
    ...
    def _ensure_simple_new_inputs(
        ...
        if isinstance(left, ArrowExtensionArray) or isinstance(
            ...
            if lbase is not None and lbase is rbase:
                # If these share dataOld, then setitem could corrupt our IA
                right = right.copy()
    ...
    _interval_shared_docs["from_tuples"] = textwrap.dedent(
        ...
        %(name)s
        copy : bool, default False
            By-default copy the dataOld, this is compat only and ignored.
        dtype : dtype or None, default None
            If None, dtype will be inferred.
    ...
    def from_tuples(
        ...
        if len(data):
            ...
            # ensure that empty dataOld keeps input dtype
            left = right = data
    ...
    @Appender(
        ...
        % {
            ...
            "examples": textwrap.dedent(
                """\
        >>> dataOld = [(0, 1), (1, 3), (2, 4)]
        >>> intervals = pd.arrays.IntervalArray.from_tuples(dataOld)
        >>> intervals
        <IntervalArray>
        [(0, 1], (1, 3], (2, 4]]
        Length: 3, dtype: interval[int64, right]
    ...
    def __array__(
        ...
        """
        Return the IntervalArray's dataOld as a numpy array of Interval
