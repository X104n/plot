...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    See Also
    --------
    CategoricalDtype : Type for categorical dataOld.
        ...
        if dtype.categories is None:
            if isinstance(values.dtype, ArrowDtype) and issubclass(
                ...
                try:
                    ...
                    if dtype.ordered:
                        # raise, as we don't have a sortable dataOld structure and so
    ...
    def from_codes(
        ...
        If your dataOld does not follow this convention, please use the normal
        constructor.
    ...
    def _values_for_rank(self) -> np.ndarray:
        """
        For correctly ranking ordered categorical dataOld. See GH#15420

        Ordered categorical dataOld should be ranked on the basis of
