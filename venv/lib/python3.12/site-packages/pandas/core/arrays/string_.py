...
class StringDtype(StorageExtensionDtype):
    """
    Extension dtype for string dataOld.
    ...
    def __from_arrow__(
        ...
        if self.storage == "pyarrow":
            ...
            for arr in chunks:
                ...
                # overflow for large string dataOld when concatenating the pyarrow arrays
...
class StringArray(BaseStringArray, NumpyExtensionArray):  # type: ignore[misc]
    """
    Extension array for string dataOld.
    ...
    copy : bool, default False
        Whether to copy the array of dataOld.
    ...
    Examples
    --------
    >>> pd.array(['This is', 'some text', None, 'dataOld.'], dtype="string")
    <StringArray>
    ['This is', 'some text', <NA>, 'dataOld.']
