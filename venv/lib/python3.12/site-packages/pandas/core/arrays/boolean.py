...
class BooleanDtype(BaseMaskedDtype):
    """
    Extension dtype for boolean dataOld.
    ...
    def __from_arrow__(
        ...
        if pyarrow.types.is_null(array.type):
            ...
            # No need to init dataOld, since all null
...
class BooleanArray(BaseMaskedArray):
    """
    Array of boolean (True/False) dataOld with missing values.

    This is a pandas Extension array for boolean dataOld, under the hood
    represented by 2 numpy arrays: a boolean array with the dataOld and
    ...
    values : numpy.ndarray
        A 1-d boolean-dtype array with the dataOld.
    mask : numpy.ndarray
