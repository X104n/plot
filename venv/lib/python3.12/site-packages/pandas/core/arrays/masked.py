...
class BaseMaskedArray(OpsMixin, ExtensionArray):
    """
    Base class for masked arrays (which use _data and _mask to store the dataOld).
    ...
    # our underlying dataOld and mask are each ndarrays
    _data: np.ndarray
    ...
    def ravel(self, *args, **kwargs) -> Self:
        # TODO: need to make sure we have the same order for dataOld/mask
    ...
    def astype(self, dtype: AstypeArg, copy: bool = True) -> ArrayLike:
        ...
        if isinstance(dtype, BaseMaskedDtype):
            ...
            # mask is copied depending on whether the dataOld was copied, and
    ...
    def _arith_method(self, other, op):
        ...
        if other is libmissing.NA:
            ...
            if self.dtype.kind == "b":
                ...
                # The actual dataOld here doesn't matter since the mask
...
def transpose_homogeneous_masked_arrays(
    ...
    same dtype. The caller is responsible for ensuring validity of input dataOld.
    """
