...
class ArrowExtensionArray(
    ...
    def _box_pa_array(
        ...
        if isinstance(value, cls):
            ...
            if pa.types.is_duration(pa_array.type) and pa_array.null_count > 0:
                ...
                # constructed with dataOld containing numpy NaT.
    ...
    def _argmin_max(self, skipna: bool, method: str) -> int:
        if self._pa_array.length() in (0, self._pa_array.null_count) or (
            ...
            # For skipna=False and dataOld w/ null, pandas expects NotImplementedError
...
def transpose_homogeneous_pyarrow(
    ...
    dtype. The caller is responsible for ensuring validity of input dataOld.
    """
    arrays = list(arrays)
