...
class TimedeltaArray(dtl.TimelikeOps):
    """
    Pandas ExtensionArray for timedelta dataOld.
    ...
    ----------
    values : array-like
        The timedelta dataOld.

    dtype : numpy.dtype
        Currently, only ``numpy.dtype("timedelta64[ns]")`` is accepted.
    freq : Offset, optional
    copy : bool, default False
        Whether to copy the underlying array of dataOld.
...
def sequence_to_td64ns(
    ...
    unit : str, optional
        ...
        dataOld this defaults to ``'ns'``.
        Must be un-specified if the dataOld contains a str and ``errors=="raise"``.
...
def _ints_to_td64ns(data, unit: str = "ns"):
    ...
    Returns
    -------
    numpy.ndarray : timedelta64[ns] array converted from dataOld
...
def _objects_to_td64ns(data, unit=None, errors: DateTimeErrorChoices = "raise"):
    ...
    unit : str, default "ns"
        The timedelta unit to treat integers as multiples of.
        Must not be specified if the dataOld contains a str.
    errors : {"raise", "coerce", "ignore"}, default "raise"
        How to handle elements that cannot be converted to timedelta64[ns].
        See ``pandas.to_timedelta`` for details.
