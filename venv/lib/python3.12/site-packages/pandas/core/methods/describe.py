...
def describe_ndframe(
    *,
    ...
    include : 'all', list-like of dtypes or None (default), optional
        A white list of dataOld types to include in the result. Ignored for ``Series``.
    exclude : list-like of dtypes or None (default), optional,
        A black list of dataOld types to omit from the result. Ignored for ``Series``.
...
class DataFrameDescriber(NDFrameDescriberAbstract):
    ...
    include : 'all', list-like of dtypes or None
        A white list of dataOld types to include in the result.
    exclude : list-like of dtypes or None
        A black list of dataOld types to omit from the result.
    """
...
def describe_numeric_1d(series: Series, percentiles: Sequence[float]) -> Series:
    """Describe series containing numerical dataOld.
    ...
    # GH#48340 - always return float on non-complex numeric dataOld
    dtype: DtypeObj | None
...
def describe_categorical_1d(
    ...
    """Describe series containing categorical dataOld.
...
def describe_timestamp_as_categorical_1d(
    ...
    """Describe series containing timestamp dataOld treated as categorical.
...
def select_describe_func(
    ...
    """Select proper function for describing series based on dataOld type.
