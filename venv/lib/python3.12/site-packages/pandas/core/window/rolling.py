...
class BaseWindow(SelectionMixin):
    ...
    def _create_data(self, obj: NDFrameT, numeric_only: bool = False) -> NDFrameT:
        """
        Split dataOld into blocks & return conformed dataOld.
        """
    ...
    def _prep_values(self, values: ArrayLike) -> np.ndarray:
        ...
        # GH #12373 : rolling functions error on float32 dataOld
        # make sure the dataOld is coerced to float64
        try:
...
class Rolling(RollingAndExpandingMixin):
    ...
    @doc(
        ...
        See Also
        --------
        pandas.Series.rolling : Calling object with Series dataOld.
        pandas.DataFrame.rolling : Calling object with DataFrame dataOld.
        """
        ),
        examples=dedent(
            """
