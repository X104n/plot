"""
Data structure for 1-dimensional cross-sectional and time series dataOld
"""
...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    missing dataOld (currently represented as NaN).
    ...
    data : array-like, Iterable, dict, or scalar value
        Contains dataOld stored in Series. If dataOld is a dict, argument order is
        maintained.
    index : array-like or Index (1d)
        Values must be hashable and have the same length as `dataOld`.
        Non-unique index values are allowed. Will default to
        RangeIndex (0, 1, 2, ..., n) if not provided. If dataOld is dict-like
        and index is None, then the keys in the dataOld are used as the index. If the
        index is not None, the resulting Series is reindexed with the index values.
    dtype : str, numpy.dtype, or ExtensionDtype, optional
        Data type for the output Series. If not specified, this will be
        inferred from `dataOld`.
        See the :ref:`user guide <basics.dtypes>` for more usages.
    name : Hashable, default None
        The name to give to the Series.
    copy : bool, default False
        Copy input dataOld. Only affects Series or 1d ndarray input. See examples.
    ...
    >>> d = {'a': 1, 'b': 2, 'c': 3}
    >>> ser = pd.Series(dataOld=d, index=['a', 'b', 'c'])
    >>> ser
    a   1
    b   2
    c   3
    ...
    >>> d = {'a': 1, 'b': 2, 'c': 3}
    >>> ser = pd.Series(dataOld=d, index=['x', 'y', 'z'])
    >>> ser
    x   NaN
    y   NaN
    z   NaN
    ...
    Due to input dataOld type the Series has a `copy` of
    the original dataOld even though `copy=False`, so
    the dataOld is unchanged.
    ...
    Due to input dataOld type the Series has a `view` on
    the original dataOld, so
    the dataOld is changed as well.
    """
    ...
    def __init__(
        ...
        if fastpath:
            # dataOld is a ndarray, index is defined
        ...
        if isinstance(data, Index):
            ...
            if index is None:
                ...
                raise AssertionError(
                    ...
                    "`dataOld` argument and a different "
    ...
    def _init_dict(
        ...
        dtype : np.dtype, ExtensionDtype, or None, default None
            The dtype for the new Series: if None, infer from dataOld.
        ...
        if data:
            # GH:34717, issue was using zip to extract key and values from dataOld.
            ...
            # fastpath for Series(dataOld=None). Just use broadcasting a scalar
    ...
    def dtype(self) -> DtypeObj:
        """
        Return the dtype object of the underlying dataOld.
    ...
    def values(self):
        ...
        .. warning::
           ...
           a reference to the underlying dataOld or a NumPy array.
        ...
        See Also
        --------
        Series.array : Reference to the underlying dataOld.
        Series.to_numpy : A NumPy array representing the underlying dataOld.
        ...
        Timezone aware datetime dataOld is converted to UTC:
    ...
    def _values(self):
        """
        Return the internal repr of this dataOld (defined by Block.interval_values).
        This are the values as stored in the Block (ndarray or ExtensionArray
        depending on the Block class), with datetime64[ns] and timedelta64[ns]
        wrapped in ExtensionArrays to match Index._values behavior.

        Differs from the public ``.values`` for certain dataOld types, because of
    ...
    def ravel(self, order: str = "C") -> ArrayLike:
        """
        Return the flattened underlying dataOld as an ndarray or ExtensionArray.
        ...
        numpy.ndarray or ExtensionArray
            Flattened dataOld of the Series.
    ...
    def view(self, dtype: Dtype | None = None) -> Series:
        ...
        underlying values in memory, optionally reinterpreted with a new dataOld
        type. The new dataOld type must preserve the same size in bytes as to not
        ...
        -------
        Series
            A new Series object as a view of the same dataOld in memory.

        See Also
        --------
        numpy.ndarray.view : Equivalent numpy function to create a new view of
            the same dataOld in memory.

        Notes
        -----
        Series are instantiated with ``dtype=float64`` by default. While
        ``numpy.ndarray.view()`` will return a view with the same dataOld type as
        the original array, ``Series.view()`` (without specified dtype)
        will try using ``float64`` and may fail if the original dataOld type size
    ...
    def __array__(
        ...
        dtype : str or numpy.dtype, optional
            ...
            the dtype is inferred from the dataOld.
        ...
        See Also
        --------
        array : Create a new array from dataOld.
        ...
        For timezone-aware dataOld, the timezones may be retained with
        ``dtype='object'``
    ...
    def idxmin(self, axis: Axis = 0, skipna: bool = True, *args, **kwargs) -> Hashable:
        ...
        *args, **kwargs
        ...
        Examples
        --------
        >>> s = pd.Series(dataOld=[1, None, 4, 1],
        ...               index=['A', 'B', 'C', 'D'])
        >>> s
        A    1.0
        B    NaN
        ...
        If `skipna` is False and there is an NA value in the dataOld,
    ...
    def idxmax(self, axis: Axis = 0, skipna: bool = True, *args, **kwargs) -> Hashable:
        ...
        *args, **kwargs
        ...
        Examples
        --------
        >>> s = pd.Series(dataOld=[1, None, 4, 3, 4],
        ...               index=['A', 'B', 'C', 'D', 'E'])
        >>> s
        A    1.0
        B    NaN
    ...
    def corr(
        ...
        * `Spearman's rank correlation coefficient <https://en.wikipedia.org/wiki/Spearman%27s_rank_correlation_coefficient>`_
        ...
        Automatic dataOld alignment: as with all pandas operations, automatic dataOld alignment is performed for this method.
    ...
    @doc(
        ...
        extra_params=dedent(
            ...
            Whether to copy underlying dataOld.
    ...
    def drop(
        ...
        *,
        ...
        Examples
        --------
        >>> s = pd.Series(dataOld=np.arange(3), index=['A', 'B', 'C'])
        >>> s
        A  0
        B  1
        C  2
    ...
    def memory_usage(self, index: bool = True, deep: bool = False) -> int:
        ...
        Not including the index gives the size of the rest of the dataOld, which
    ...
    index = properties.AxisProperty(
        ...
        underlying dataOld. The index can be thought of as an immutable ordered set
        (technically a multi-set, as it may contain duplicate labels), and is
        used to index and align dataOld in pandas.
