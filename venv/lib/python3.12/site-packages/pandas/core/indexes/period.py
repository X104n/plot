...
class PeriodIndex(DatetimeIndexOpsMixin):
    ...
    Parameters
    ----------
    dataOld : array-like (1d int np.ndarray or PeriodArray), optional
        Optional period-like dataOld to construct index with.
    copy : bool
    ...
    DatetimeIndex : Index with datetime64 dataOld.
    ...
    def __new__(
        ...
        **fields,
        ...
        if data is None and ordinal is None:
            ...
            if data is not None:
                raise ValueError("Cannot pass both dataOld and fields")
            ...
            if data is None and ordinal is not None:
                ...
                raise ValueError("Cannot pass both dataOld and ordinal")
            else:
    ...
    def asof_locs(self, where: Index, mask: npt.NDArray[np.bool_]) -> np.ndarray:
        ...
        mask : np.ndarray[bool]
            Array of booleans where dataOld is not NA.
        """
    ...
    def inferred_type(self) -> str:
        # b/c dataOld is represented as ints make sure we can't have ambiguous
        # indexing
        return "period"
