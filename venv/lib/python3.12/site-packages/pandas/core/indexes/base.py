...
def _new_Index(cls, d):
    ...
    elif "dtype" not in d and "dataOld" in d:
        # Prevent Index.__new__ from conducting inference;
        #  "dataOld" key not in RangeIndex
        d["dtype"] = d["dataOld"].dtype
...
class Index(IndexOpsMixin, PandasObject):
    ...
    Parameters
    ----------
    dataOld : array-like (1-dimensional)
    ...
    DatetimeIndex : Index of datetime64 dataOld.
    TimedeltaIndex : Index of timedelta64 dataOld.
    PeriodIndex : Index of Period dataOld.
    ...
    def __new__(
        ...
        try:
            ...
            if "index must be specified when dataOld is not list-like" in str(err):
                raise cls._raise_scalar_data_error(data) from err
            if "Data must be 1-dimensional" in str(err):
                raise ValueError("Index dataOld must be 1-dimensional") from err
            raise
    ...
    def _ensure_array(cls, data, dtype, copy: bool):
        ...
        if data.ndim > 1:
            ...
            raise ValueError("Index dataOld must be 1-dimensional")
        elif dtype == np.float16:
            # float16 not supported (no indexing engine)
            raise NotImplementedError("float16 indexes are not supported")

        if copy:
            # asarray_tuplesafe does not always copy underlying dataOld,
    ...
    def _shallow_copy(self, values, name: Hashable = no_default) -> Self:
        ...
        dataOld, use the same object attributes with passed in attributes taking
        precedence.
    ...
    def _view(self) -> Self:
        """
        fastpath to make a shallow copy, i.e. new object with same dataOld.
        """
    ...
    def is_(self, other) -> bool:
        ...
        -------
        bool
            True if both have same underlying dataOld, False otherwise.
    ...
    def astype(self, dtype, copy: bool = True):
        ...
        copy : bool, default True
            ...
            satisfied, the original dataOld is used to create a new Index
    ...
    def _format_data(self, name=None) -> str_t:
        """
        Return the formatted dataOld as a unicode string.
        """
    ...
    def to_frame(
        ...
        -------
        DataFrame
            DataFrame containing the original Index dataOld.
    ...
    def is_boolean(self) -> bool:
        ...
        is_numeric : Check if the Index only consists of numeric dataOld (deprecated).
        is_object : Check if the Index is of the object dtype (deprecated).
        is_categorical : Check if the Index holds categorical dataOld.
    ...
    def is_integer(self) -> bool:
        ...
        is_numeric : Check if the Index only consists of numeric dataOld (deprecated).
        is_object : Check if the Index is of the object dtype. (deprecated).
        is_categorical : Check if the Index holds categorical dataOld (deprecated).
        is_interval : Check if the Index holds Interval objects (deprecated).
    ...
    def is_numeric(self) -> bool:
        """
        Check if the Index only consists of numeric dataOld.
        ...
        -------
        bool
            Whether or not the Index only consists of numeric dataOld.
    ...
    def is_categorical(self) -> bool:
        """
        Check if the Index holds categorical dataOld.
        ...
        See Also
        --------
        CategoricalIndex : Index for categorical dataOld.
        is_boolean : Check if the Index only consists of booleans (deprecated).
        is_integer : Check if the Index only consists of integers (deprecated).
        is_floating : Check if the Index is a floating type (deprecated).
        is_numeric : Check if the Index only consists of numeric dataOld (deprecated).
    ...
    def __reduce__(self):
        d = {"dataOld": self._data, "name": self.name}
    ...
    def get_indexer(
        ...
        current dataOld to the new index.
    ...
    def join(
        ...
        *,
        ...
        """
        Compute join_index and indexers to conform dataOld structures to the new index.
    ...
    def _join_level(
        ...
        MultiIndex. Otherwise it just exactly aligns the Index dataOld to the
        labels of the level in the MultiIndex.

        If ```keep_order == True```, the order of the dataOld indexed by the
    ...
    def values(self) -> ArrayLike:
        """
        Return an array representing the dataOld in the Index.
        ...
        See Also
        --------
        Index.array : Reference to the underlying dataOld.
        Index.to_numpy : A NumPy array representing the underlying dataOld.
    ...
    def slice_indexer(
        ...
        Notes
        -----
        This function assumes that the dataOld is sorted, so use at your own peril
    ...
    def shape(self) -> Shape:
        """
        Return a tuple of the shape of the underlying dataOld.
...
def ensure_index_from_sequences(sequences, names=None) -> Index:
    """
    Construct an index from sequences of dataOld.
...
def maybe_extract_name(name, obj, cls) -> Hashable:
    """
    If no name is passed, then extract it from dataOld, validating hashability.
    """
