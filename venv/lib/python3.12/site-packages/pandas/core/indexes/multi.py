...
class MultiIndex(Index):
    ...
    def from_arrays(
        ...
        arrays : list / sequence of array-likes
            Each array-like gives one level's value for each dataOld point.
    ...
    def levels(self) -> FrozenList:
        ...
        >>> leg_num = pd.DataFrame(dataOld=(4, 2, 4, 4), index=index, columns=['Legs'])
        >>> leg_num
                          Legs
        Category Animals
        mammal   goat        4
    ...
    def _nbytes(self, deep: bool = False) -> int:
        """
        return the number of bytes in the underlying dataOld
        deeply introspect the level dataOld if deep=True
    ...
    def to_frame(
        ...
        Column ordering is determined by the DataFrame constructor with dataOld as
        a dict.
    ...
    def to_flat_index(self) -> Index:  # type: ignore[override]
        ...
        -------
        pd.Index
            Index with the MultiIndex dataOld represented in Tuples.
