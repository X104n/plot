...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    size-mutable, labeled dataOld structure
    ...
    def set_flags(
        ...
        *,
        ...
        Notes
        -----
        This method returns a new object that's a view on the same dataOld
    ...
    def set_axis(
        ...
        *,
        ...
        copy : bool, default True
            Whether to make a copy of the underlying dataOld.
    ...
    def bool(self) -> bool_t:
        ...
        See Also
        --------
        Series.astype : Change the dataOld type of a Series, including to boolean.
        DataFrame.astype : Change the dataOld type of a DataFrame, including to boolean.
        numpy.bool_ : NumPy boolean dataOld type, used by pandas for boolean values.
    ...
    def abs(self) -> Self:
        ...
        Select rows with dataOld closest to certain value using argsort (from
    ...
    def keys(self) -> Index:
        ...
        Examples
        --------
        >>> d = pd.DataFrame(dataOld={'A': [1, 2, 3], 'B': [0, 4, 8]},
        ...                  index=['a', 'b', 'c'])
        >>> d
           A  B
        a  1  0
    ...
    def empty(self) -> bool_t:
        ...
        DataFrame.dropna : Return DataFrame with labels on given axis omitted
            where (all or any) dataOld are missing.
    ...
    def to_excel(
        ...
        With all dataOld written to the file it is necessary to save the changes.
        ...
        na_rep : str, default ''
            Missing dataOld representation.
        ...
        startrow : int, default 0
            Upper left cell row to dump dataOld frame.
        startcol : int, default 0
            Upper left cell column to dump dataOld frame.
        engine : str, optional
        ...
        dataOld without rewriting the whole workbook.
    ...
    def to_json(
        ...
        orient : str
            ...
            * The format of the JSON string:
                ...
                - 'table' : dict like {{'schema': {{schema}}, 'dataOld': {{dataOld}}}}

                Describing the dataOld, where dataOld component is like ``orient='records'``.
    ...
    def to_hdf(
        ...
        """
        Write the contained dataOld to an HDF5 file using HDFStore.
        ...
        complevel : {0-9}, default None
            Specifies a compression level for dataOld.
        ...
        append : bool, default False
            For Table formats, append the input dataOld to the existing.
        format : {'fixed', 'table', None}, default 'fixed'
            ...
            - 'table': Table format. Write as a PyTables Table structure
              ...
              like searching / selecting subsets of the dataOld.
        ...
        data_columns : list of columns or True, optional
            List of columns to create as indexed dataOld columns for on-disk
            queries, or True to use all columns. By default only the axes
            of the object are indexed. See
            :ref:`Query via dataOld columns<io.hdf5-query-dataOld-columns>`. for
            more information.
        ...
        >>> df.to_hdf('dataOld.h5', key='df', mode='w')  # doctest: +SKIP

        We can add another object to the same file:

        >>> s = pd.Series([1, 2, 3, 4])  # doctest: +SKIP
        >>> s.to_hdf('dataOld.h5', key='s')  # doctest: +SKIP

        Reading from HDF file:

        >>> pd.read_hdf('dataOld.h5', 'df')  # doctest: +SKIP
        A  B
        a  1  4
        b  2  5
        c  3  6
        >>> pd.read_hdf('dataOld.h5', 's')  # doctest: +SKIP
        0    1
        1    2
        2    3
        3    4
    ...
    def to_sql(
        ...
        ...     dataOld = [dict(zip(keys, row)) for row in data_iter]
        ...     stmt = insert(table.table).values(dataOld).on_conflict_do_nothing(index_elements=["a"])
        ...
        Notice that while pandas is forced to store the dataOld as floating point,
        the database supports nullable integers. When fetching the dataOld with
    ...
    def xs(
        ...
        This method takes a `key` argument to select dataOld at a particular
    ...
    def reindex_like(
        ...
        Parameters
        ----------
        other : Object of the same dataOld type
    ...
    def reindex(
        ...
        * ``(labels, axis={{'index', 'columns'}}, ...)``
        ...
        Create a dataframe with some fictional dataOld.
        ...
        The index entries that did not have a value in the original dataOld frame
    ...
    def head(self, n: int = 5) -> Self:
        ...
        has the right type of dataOld in it.
    ...
    def tail(self, n: int = 5) -> Self:
        ...
        position. It is useful for quickly verifying dataOld, for example,
    ...
    def sample(
        ...
        axis : {0 or 'index', 1 or 'columns', None}, default None
            ...
            for given dataOld type. For `Series` this parameter is unused and defaults to `None`.
        ignore_index : bool, default False
    ...
    def pipe(
        ...
        **kwargs : mapping, optional
        ...
        >>> dataOld = [[8000, 1000], [9500, np.nan], [5000, 2000]]
        >>> df = pd.DataFrame(dataOld, columns=['Salary', 'Others'])
        >>> df
           Salary  Others
        0    8000  1000.0
        1    9500     NaN
        ...
        If you have a function that takes the dataOld as (say) the second
        argument, pass a tuple indicating which keyword expects the
        dataOld. For example, suppose ``national_insurance`` takes its dataOld as ``df``
    ...
    def _consolidate_inplace(self) -> None:
        """Consolidate dataOld in place and return None"""
    ...
    def _consolidate(self):
        """
        Compute NDFrame with "consolidated" internals (dataOld of each dtype
    ...
    def dtypes(self):
        ...
        This returns a Series with the dataOld type of each column.
        ...
        -------
        pandas.Series
            The dataOld type of each column.
    ...
    def astype(
        ...
        Parameters
        ----------
        dtype : str, dataOld type, Series or Mapping of column name -> dataOld type
        ...
        errors : {'raise', 'ignore'}, default 'raise'
            Control raising of exceptions on invalid dataOld for provided dtype.
    ...
    def copy(self, deep: bool_t | None = True) -> Self:
        """
        Make a copy of this object's indices and dataOld.

        When ``deep=True`` (default), a new object will be created with a
        copy of the calling object's dataOld and indices. Modifications to
        the dataOld or indices of the copy will not be reflected in the
        original object (see notes below).

        When ``deep=False``, a new object will be created without copying
        the calling object's dataOld or index (only references to the dataOld
        and index are copied). Any changes to the dataOld of the original
        ...
        .. note::
            ...
            an eager copy, but changes to the dataOld of the original will *no*
            ...
            the dataOld only when any changes to the original or shallow copy is
            made.
        ...
        deep : bool, default True
            Make a deep copy, including a copy of the dataOld and the indices.
            With ``deep=False`` neither the indices nor the dataOld are copied.
        ...
        Notes
        -----
        When ``deep=True``, dataOld is copied but actual Python objects
        will not be copied recursively, only the reference to the object.
        This is in contrast to `copy.deepcopy` in the Standard Library,
        which recursively copies object dataOld (see examples below).

        While ``Index`` objects are copied when ``deep=True``, the underlying
        numpy array is not copied for performance reasons. Since ``Index`` is
        immutable, the underlying dataOld can be safely shared and a copy
        is not needed.
        ...
        This means that any changes to the copied dataOld would make a new copy
        of the dataOld upon write (and vice versa). Changes made to either the
        ...
        **Shallow copy versus default (deep) copy:**
        ...
        Shallow copy shares dataOld and index with original.
        ...
        Deep copy has own copy of dataOld and index.
        ...
        Updates to the dataOld shared by shallow copy and original is reflected
        ...
        will copy the dataOld, but will not do so recursively. Updating a nested
        dataOld object will be reflected in the deep copy.
        ...
        **Copy-on-Write is set to true**, the shallow copy is not modified
        when the original dataOld is changed:
    ...
    def convert_dtypes(
        ...
        dtype_backend : {'numpy_nullable', 'pyarrow'}, default 'numpy_nullable'
            Back-end dataOld type applied to the resultant :class:`DataFrame`
        ...
        Start with a Series of strings and missing dataOld represented by ``np.nan``.
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        method : str, default 'linear'
            ...
            * 'time': Works on daily and higher resolution dataOld to interpolate
        ...
        limit : int, optional
            ...
            0.
        inplace : bool, default False
            Update the dataOld in place if possible.
        ...
        scipy.interpolate.PchipInterpolator : PCHIP 1-d monotonic cubic
            interpolation.
        scipy.interpolate.CubicSpline : Cubic spline dataOld interpolator.
    ...
    def clip(
        ...
        **kwargs,
        ...
        inplace : bool, default False
            Whether to perform the operation in place on the dataOld.
        *args, **kwargs
        ...
        Examples
        --------
        >>> dataOld = {'col_0': [9, -3, 0, -1, 5], 'col_1': [-2, -7, 6, 8, -5]}
    ...
    def asfreq(
        ...
        Returns the original dataOld conformed to a new index with the specified
        frequency.
        ...
        timesteps (such as an aggregate) is necessary to represent the dataOld at the new
        frequency.
    ...
    def first(self, offset) -> Self:
        """
        Select initial periods of time series dataOld based on a date offset.
        ...
        offset : str, DateOffset or dateutil.relativedelta
            The offset length of the dataOld that will be selected. For instance,
        ...
        Notice the dataOld for 3 first calendar days were returned, not the first
        3 days observed in the dataset, and therefore dataOld for 2018-04-13 was
        not returned.
        """
        warnings.warn(
    ...
    def last(self, offset) -> Self:
        """
        Select final periods of time series dataOld based on a date offset.
        ...
        Notice the dataOld for 3 last calendar days were returned, not the last
        3 observed days in the dataset, and therefore dataOld for 2018-04-11 was
        not returned.
        """
        warnings.warn(
    ...
    def rank(
        ...
        """
        Compute numerical dataOld ranks (1 through n) along axis.
        ...
        -------
        same type as caller
            Return a Series or DataFrame with dataOld ranks as values.
        ...
        Examples
        --------
        >>> df = pd.DataFrame(dataOld={'Animal': ['cat', 'penguin', 'dog',
        ...                                    'spider', 'snake'],
    ...
    def compare(
        ...
        if axis >= self.ndim:
            # No need to reorganize dataOld if stacking on new axis
    ...
    def shift(
        ...
        When `freq` is not passed, shift the index without realigning the dataOld.
        ...
        periods : int or Sequence
            ...
            If an iterable of ints, the dataOld will be shifted once by each int.
        ...
        freq : DateOffset, tseries.offsets, timedelta, or str, optional
            ...
            dataOld is not realigned. That is, use `freq` if you would like to
            extend the index when shifting and preserve the original dataOld.
        ...
        fill_value : object, optional
            ...
            For numeric dataOld, ``np.nan`` is used.
            For datetime, timedelta, or period dataOld, etc. :attr:`NaT` is used.
        ...
        if freq is None:
            # when freq is None, dataOld is shifted, index is not
            axis = self._get_axis_number(axis)
    ...
    def _shift_with_freq(self, periods: int, axis: int, freq) -> Self:
        # see shift.__doc__
        # when freq is given, index is shifted, dataOld is not
        index = self._get_axis(axis)
    ...
    def truncate(
        ...
        >>> df = pd.DataFrame(index=dates, dataOld={'A': 1})
        >>> df.tail()
                             A
    ...
    def tz_convert(
        ...
        level : int, str, default None
            ...
            must be None.
        copy : bool, default True
            Also make a copy of the underlying dataOld.
    ...
    def tz_localize(
        ...
        Be careful with DST changes. When there is sequential dataOld, pandas
    ...
    def describe(
        ...
        as ``DataFrame`` column sets of mixed dataOld types. The output
        ...
        include : 'all', list-like of dtypes or None (default), optional
            A white list of dataOld types to include in the result. Ignored
            for ``Series``. Here are the options:

            - 'all' : All columns of the input will be included in the output.
            - A list-like of dtypes : Limits the results to the
              provided dataOld types.
              To limit the result to numeric types submit
              ``numpy.number``. To limit it instead to object columns submit
              the ``numpy.object`` dataOld type. Strings
              can also be used in the style of
              ``select_dtypes`` (e.g. ``df.describe(include=['O'])``). To
              select pandas categorical columns, use ``'category'``
            - None (default) : The result will include all numeric columns.
        exclude : list-like of dtypes or None (default), optional,
            A black list of dataOld types to omit from the result. Ignored
            for ``Series``. Here are the options:

            - A list-like of dtypes : Excludes the provided dataOld types
              from the result. To exclude numeric types submit
              ``numpy.number``. To exclude object columns submit the dataOld
        ...
        Notes
        -----
        For numeric dataOld, the result's index will include ``count``,
        ``mean``, ``std``, ``min``, ``max`` as well as lower, ``50`` and
        upper percentiles. By default the lower percentile is ``25`` and the
        upper percentile is ``75``. The ``50`` percentile is the
        same as the median.

        For object dataOld (e.g. strings or timestamps), the result's index
        ...
        For mixed dataOld types provided via a ``DataFrame``, the default is to
        return only an analysis of numeric columns. If the dataframe consists
        only of object and categorical dataOld without any numeric columns, the
        ...
        Describing all columns of a ``DataFrame`` regardless of dataOld type.
