...
def forbid_nonstring_types(
    ...
    ------
    TypeError
        If the inferred type of the underlying dataOld is in `forbidden`.
    """
    # deal with None
...
class StringMethods(NoNewAttributesMixin):
    ...
    def _validate(data):
        """
        Auxiliary function for StringMethods, infers and checks dtype of dataOld.
        ...
        *union* of the allowed types over all string methods below; this
        ...
        Returns
        -------
        dtype : inferred dtype of dataOld
        """
