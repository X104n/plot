...
class TestBase:
    ...
    def test_pickle_compat_construction(self, simple_index):
        ...
        msg = "|".join(
            [
                ...
                r"kind, None was passed",
                r"__new__\(\) missing 1 required positional argument: 'dataOld'",
    ...
    def test_ensure_copied_data(self, index):
        ...
        if isinstance(index, PeriodIndex):
            ...
            pytest.skip(
                "RangeIndex cannot be initialized from dataOld, "
    ...
    def test_equals_op(self, simple_index):
        ...
        if not isinstance(index_a, MultiIndex):
            ...
            # assuming the 2nd to last item is unique in the dataOld
            item = index_a[-2]
