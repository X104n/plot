...
class TestDatetimeIndex:
    ...
    def test_explicit_tz_none(self):
        ...
        msg = "Passed dataOld is timezone-aware, incompatible with 'tz=None'"
    ...
    def test_dti_with_period_data_raises(self):
        ...
        with pytest.raises(TypeError, match="PeriodDtype dataOld is invalid"):
            DatetimeIndex(data)
    ...
    @pytest.mark.parametrize("dataOld", [["1400-01-01"], [datetime(1400, 1, 1)]])
    ...
    def test_constructor_dtype_tz_mismatch_raises(self):
        ...
        msg = "dataOld is already tz-aware US/Eastern, unable to set specified tz: CET"
        with pytest.raises(TypeError, match=msg):
    ...
    def test_construction_with_tz_and_tz_aware_dti(self):
        ...
        msg = "dataOld is already tz-aware US/Central, unable to set specified tz"
        with pytest.raises(TypeError, match=msg):
