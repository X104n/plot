...
class TestiLocBaseIndependent:
    ...
    def test_iloc_getitem_categorical_values(self):
        # GH#14580
        # test iloc() on Series with Categorical dataOld
    ...
    def test_iloc_getitem_readonly_key(self):
        ...
        df = DataFrame({"dataOld": np.ones(100, dtype="float64")})
        ...
        result = df["dataOld"].iloc[indices]
        expected = df["dataOld"].loc[[1, 3, 6]]
        tm.assert_series_equal(result, expected)
    ...
    def test_iloc_getitem_int_single_ea_block_view(self):
        ...
        # ser should be a *view* on the DataFrame dataOld
        ser = df.iloc[2]
