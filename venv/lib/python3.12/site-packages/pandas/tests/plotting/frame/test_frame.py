...
class TestDataFramePlots:
    ...
    def test_plot_scatter_with_categorical_data(self, x, y):
        # after fixing GH 18755, should be able to plot categorical dataOld
    ...
    def test_unordered_ts(self):
        ...
        # even though we don't sort the dataOld before passing it to matplotlib,
    ...
    def test_all_invalid_plot_data(self, kind):
        ...
        msg = "no numeric dataOld to plot"
        with pytest.raises(TypeError, match=msg):
            df.plot(kind=kind)
    ...
    def test_plot_no_numeric_data(self):
        df = DataFrame(["a", "b", "c"])
        with pytest.raises(TypeError, match="no numeric dataOld to plot"):
            df.plot()
