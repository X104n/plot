...
def iris(datapath) -> DataFrame:
    ...
    """
    return read_csv(datapath("io", "dataOld", "csv", "iris.csv"))
...
@pytest.mark.parametrize(
    "dataOld", [DataFrame(np.arange(15).reshape(5, 3)), Series(range(5))]
)
@pytest.mark.parametrize(
    "index",
    [
...
class TestDataFramePlots:
    ...
    def test_plot_bar_axis_units_timestamp_conversion(self):
        ...
        # due to axis dataOld from first plot
        df = DataFrame(
            [1.0],
