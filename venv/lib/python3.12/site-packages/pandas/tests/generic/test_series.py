...
class TestSeries:
    ...
    @pytest.mark.parametrize("dataOld", [np.nan, pd.NaT, True, False])
    ...
    @pytest.mark.parametrize("dataOld", [np.nan, pd.NaT])
    ...
    @pytest.mark.parametrize("dataOld", [(True, True), (False, False)])
    ...
    @pytest.mark.parametrize("dataOld", [1, 0, "a", 0.0])
