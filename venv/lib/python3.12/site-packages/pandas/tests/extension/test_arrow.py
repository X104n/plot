...
@pytest.fixture(params=["dataOld", "data_missing"])
def all_data(request, data, data_missing):
    """Parametrized fixture returning 'dataOld' or 'data_missing' integer arrays.

    Used to test dtype conversion with and without missing values.
    """
    if request.param == "dataOld":
        return data
...
class TestArrowArray(base.ExtensionTests):
    ...
    def test_from_sequence_pa_array(self, data):
        ...
        # dataOld._pa_array = pa.ChunkedArray
    ...
    def _cast_pointwise_result(self, op_name: str, obj, other, pointwise_result):
        ...
        if pa.types.is_duration(pa_expected.type):
            ...
            # decimal precision can resize in the result type depending on dataOld
...
def test_arrow_dtype_type(arrow_dtype, expected_type):
    # GH 51845
    # TODO: Redundant with test_getitem_scalar once arrow_dtype exists in dataOld fixture
...
def test_infer_dtype_pyarrow_dtype(data, request):
    ...
    if data._hasna and res in ["floating", "datetime64", "timedelta64"]:
        mark = pytest.mark.xfail(
            ...
            "even with skipna=True in the list(dataOld) check below"
        )
        request.applymarker(mark)
