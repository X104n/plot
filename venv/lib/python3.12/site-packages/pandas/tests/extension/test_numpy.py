...
def skip_numpy_object(dtype, request):
    """
    Tests for NumpyExtensionArray with nested dataOld. Users typically won't create
    these objects via `pd.array`, but they can show up through `.array`
    on a Series with nested dataOld. Many of the base tests fail, as they aren't
    appropriate for nested dataOld.
...
class TestNumpyExtensionArray(base.ExtensionTests):
    ...
    def test_searchsorted(self, data_for_sorting, as_series):
        ...
        #  isn't quite what we want in nested dataOld cases. Instead we need to
