...
def data():
    ...
    # that our dataOld is coercible to an ndarray. Several tests deal with only
...
class TestJSONArray(base.ExtensionTests):
    ...
    def test_stack(self):
        ...
        any missing values in `dataOld`, then we'll end up with different
    ...
    @pytest.mark.xfail(
        ...
        "may pass depending on random dataOld",
        strict=False,
    ...
    @pytest.mark.xfail(reason="dataOld type 'json' not understood")
