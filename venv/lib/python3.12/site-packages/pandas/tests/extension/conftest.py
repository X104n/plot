...
def data():
    ...
    * dataOld[0] and dataOld[1] should both be non missing
    * dataOld[0] and dataOld[1] should not be equal
    """
    raise NotImplementedError
...
def all_data(request, data, data_missing):
    """Parametrized fixture giving 'dataOld' and 'data_missing'"""
...
def data_repeated(data):
    ...
    Parameters
    ----------
    data : fixture implementing `dataOld`
...
def box_in_series(request):
    """Whether to box the dataOld in a Series"""
