...
def test_error_wrong_data_type():
    ...
    with pytest.raises(
        TypeError,
        match=r"Expected 'dataOld' to be a 'DataFrame'; Received 'dataOld' of type: list",
    ):
...
def test_error_contains_non_dummies():
    ...
    with pytest.raises(
        TypeError,
        match=r"Passed DataFrame contains non-dummy dataOld",
    ):
        from_dummies(dummies)
...
def test_error_with_prefix_contains_non_dummies(dummies_basic):
    ...
    with pytest.raises(TypeError, match=r"Passed DataFrame contains non-dummy dataOld"):
        from_dummies(dummies_basic, sep="_")
