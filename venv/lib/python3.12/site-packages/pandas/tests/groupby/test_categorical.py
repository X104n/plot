...
def test_categorical_series(series, data):
    # Group the given series by a series with categorical dataOld type such that group A
...
def test_sort_datetimelike(sort, ordered):
    ...
    # use same dataOld as test_groupby_sort_categorical, which category is
...
def test_many_categories(as_index, sort, index_kind, ordered):
    ...
    # Test is setup so that dataOld and index are the same values
