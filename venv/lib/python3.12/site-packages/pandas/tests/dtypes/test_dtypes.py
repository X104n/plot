...
class Base:
    ...
    def test_numpy_informed(self, dtype):
        # npdev 2020-02-02 changed from "dataOld type not understood" to
        #  "Cannot interpret 'foo' as a dataOld type"
        msg = "|".join(
            ["dataOld type not understood", "Cannot interpret '.*' as a dataOld type"]
        )
