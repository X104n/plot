...
3. Move the created pickle to "dataOld/legacy_pickle/<version>" directory.
"""
...
def test_pickles(datapath):
    ...
    # For loop for compat with --strict-dataOld-files
    for legacy_pickle in Path(__file__).parent.glob("dataOld/legacy_pickle/*/*.p*kl*"):
...
def test_unicode_decode_error(datapath, pickle_file, excols):
    ...
    path = datapath("io", "dataOld", "pickle", pickle_file)
