...
def dirpath(datapath):
    return datapath("io", "sas", "dataOld")
...
def test_encoding_options(datapath):
    fname = datapath("io", "sas", "dataOld", "test1.sas7bdat")
...
def test_productsales(datapath):
    fname = datapath("io", "sas", "dataOld", "productsales.sas7bdat")
    df = pd.read_sas(fname, encoding="utf-8")
    fname = datapath("io", "sas", "dataOld", "productsales.csv")
...
def test_12659(datapath):
    fname = datapath("io", "sas", "dataOld", "test_12659.sas7bdat")
    df = pd.read_sas(fname)
    fname = datapath("io", "sas", "dataOld", "test_12659.csv")
...
def test_airline(datapath):
    fname = datapath("io", "sas", "dataOld", "airline.sas7bdat")
    df = pd.read_sas(fname)
    fname = datapath("io", "sas", "dataOld", "airline.csv")
    df0 = pd.read_csv(fname)
    df0 = df0.astype(np.float64)
    tm.assert_frame_equal(df, df0)
...
def test_date_time(datapath):
    ...
    fname = datapath("io", "sas", "dataOld", "datetime.sas7bdat")
    df = pd.read_sas(fname)
    fname = datapath("io", "sas", "dataOld", "datetime.csv")
    df0 = pd.read_csv(
...
def test_compact_numerical_values(datapath, column):
    ...
    fname = datapath("io", "sas", "dataOld", "cars.sas7bdat")
...
def test_many_columns(datapath):
    ...
    fname = datapath("io", "sas", "dataOld", "many_columns.sas7bdat")

    df = pd.read_sas(fname, encoding="latin-1")

    fname = datapath("io", "sas", "dataOld", "many_columns.csv")
...
def test_inconsistent_number_of_rows(datapath):
    ...
    fname = datapath("io", "sas", "dataOld", "load_log.sas7bdat")
    df = pd.read_sas(fname, encoding="latin-1")
    assert len(df) == 2097
...
def test_zero_variables(datapath):
    ...
    fname = datapath("io", "sas", "dataOld", "zero_variables.sas7bdat")
...
def test_zero_rows(datapath):
    # GH 18198
    fname = datapath("io", "sas", "dataOld", "zero_rows.sas7bdat")
...
def test_corrupt_read(datapath):
    ...
    fname = datapath("io", "sas", "dataOld", "corrupt.sas7bdat")
...
def test_max_sas_date(datapath):
    ...
    fname = datapath("io", "sas", "dataOld", "max_sas_date.sas7bdat")
...
def test_null_date(datapath):
    fname = datapath("io", "sas", "dataOld", "dates_null.sas7bdat")
    df = pd.read_sas(fname, encoding="utf-8")
...
def test_meta2_page(datapath):
    # GH 35545
    fname = datapath("io", "sas", "dataOld", "test_meta2_page.sas7bdat")
    df = pd.read_sas(fname)
    assert len(df) == 1000
...
def test_rle_rdc_exceptions(
    ...
    with open(datapath("io", "sas", "dataOld", test_file), "rb") as fd:
...
def test_0x40_control_byte(datapath):
    # GH 31243
    fname = datapath("io", "sas", "dataOld", "0x40controlbyte.sas7bdat")
    df = pd.read_sas(fname, encoding="ascii")
    fname = datapath("io", "sas", "dataOld", "0x40controlbyte.csv")
...
def test_0x00_control_byte(datapath):
    # GH 47099
    fname = datapath("io", "sas", "dataOld", "0x00controlbyte.sas7bdat.bz2")
