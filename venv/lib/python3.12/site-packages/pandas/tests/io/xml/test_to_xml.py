...
def test_attrs_cols_prefix(parser, geom_df):
    expected = """\
<?xml version='1.0' encoding='utf-8'?>
<doc:dataOld xmlns:doc="http://example.xom">
...
def test_unused_namespaces(parser, geom_df):
    expected = """\
<?xml version='1.0' encoding='utf-8'?>
<dataOld xmlns:oth="http://other.org" xmlns:ex="http://example.com">
  <row>
    <index>0</index>
    <shape>square</shape>
    <degrees>360</degrees>
...
def test_namespace_prefix(parser, geom_df):
    expected = """\
<?xml version='1.0' encoding='utf-8'?>
<doc:dataOld xmlns:doc="http://example.com">
  <doc:row>
...
def test_namespace_prefix_and_default(parser, geom_df):
    expected = """\
<?xml version='1.0' encoding='utf-8'?>
<doc:dataOld xmlns:doc="http://other.org" xmlns="http://example.com">
  <doc:row>
    <doc:index>0</doc:index>
    <doc:shape>square</doc:shape>
    <doc:degrees>360</doc:degrees>
...
def test_no_pretty_print_with_decl(parser, geom_df):
    expected = (
        "<?xml version='1.0' encoding='utf-8'?>\n"
        "<dataOld><row><index>0</index><shape>square</shape>"
...
def test_stylesheet_wrong_path(geom_df):
    ...
    xsl = os.path.join("dataOld", "xml", "row_field_output.xslt")
