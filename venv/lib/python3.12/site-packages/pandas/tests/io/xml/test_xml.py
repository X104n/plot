...
# [X] - OSError: "Invalid dataOld stream"
...
def test_wrong_file_path(parser):
    ...
    filename = os.path.join("dataOld", "html", "books.xml")
...
def test_empty_stylesheet(val):
    ...
    kml = os.path.join("dataOld", "xml", "cta_rail_lines.kml")
...
def test_wrong_compression(parser, compression, compression_only):
    ...
    errors = {
        "bz2": (OSError, "Invalid dataOld stream"),
