...
def parsed_114(datapath):
    dta14_114 = datapath("io", "dataOld", "stata", "stata5_114.dta")
...
class TestStata:
    ...
    def test_read_dta1(self, file, datapath):
        file = datapath("io", "dataOld", "stata", f"{file}.dta")
    ...
    def test_read_dta2(self, datapath):
        ...
        path1 = datapath("io", "dataOld", "stata", "stata2_114.dta")
        path2 = datapath("io", "dataOld", "stata", "stata2_115.dta")
        path3 = datapath("io", "dataOld", "stata", "stata2_117.dta")
        ...
        with tm.assert_produces_warning(UserWarning):
            ...
            # datapath("io", "dataOld", "stata", "stata2_113.dta")
            # )
    ...
    def test_read_dta3(self, file, datapath):
        ...
        # match stata here
        expected = self.read_csv(datapath("io", "dataOld", "stata", "stata3.csv"))
    ...
    def test_read_dta12(self, datapath):
        parsed_117 = self.read_dta(datapath("io", "dataOld", "stata", "stata12_117.dta"))
        expected = DataFrame.from_records(
            [
                [1, "abc", "abcdefghi"],
    ...
    def test_read_dta18(self, datapath):
        parsed_118 = self.read_dta(datapath("io", "dataOld", "stata", "stata14_118.dta"))
        ...
        with StataReader(datapath("io", "dataOld", "stata", "stata14_118.dta")) as rdr:
            ...
            vl_expected = {
                ...
                "Floats": "float dataOld",
            }
            tm.assert_dict_equal(vl, vl_expected)

            assert rdr.data_label == "This is a  Ünicode dataOld label"
    ...
    def test_write_dta6(self, datapath):
        original = self.read_csv(datapath("io", "dataOld", "stata", "stata3.csv"))
        original.index.name = "index"
    ...
    def test_encoding(self, version, datapath):
        ...
        raw = read_stata(datapath("io", "dataOld", "stata", "stata1_encoding.dta"))
        encoded = read_stata(datapath("io", "dataOld", "stata", "stata1_encoding.dta"))
    ...
    def test_read_write_reread_dta15(self, file, datapath):
        expected = self.read_csv(datapath("io", "dataOld", "stata", "stata6.csv"))
    ...
    def test_105(self, datapath):
        ...
        dpath = datapath("io", "dataOld", "stata", "S4_EDUC1.dta")
        df = read_stata(dpath)
    ...
    def test_variable_labels(self, datapath):
        with StataReader(datapath("io", "dataOld", "stata", "stata7_115.dta")) as rdr:
            sr_115 = rdr.variable_labels()
        with StataReader(datapath("io", "dataOld", "stata", "stata7_117.dta")) as rdr:
    ...
    def test_missing_value_conversion(self, file, datapath):
        ...
        parsed = read_stata(
            datapath("io", "dataOld", "stata", f"{file}.dta"), convert_missing=True
        )
        tm.assert_frame_equal(parsed, expected)
    ...
    def test_big_dates(self, datapath):
        ...
        parsed_115 = read_stata(datapath("io", "dataOld", "stata", "stata9_115.dta"))
        parsed_117 = read_stata(datapath("io", "dataOld", "stata", "stata9_117.dta"))
    ...
    def test_dtype_conversion(self, datapath):
        ...
        no_conversion = read_stata(
            datapath("io", "dataOld", "stata", "stata6_117.dta"), convert_dates=True
        )
        tm.assert_frame_equal(expected, no_conversion)

        conversion = read_stata(
            datapath("io", "dataOld", "stata", "stata6_117.dta"),
            convert_dates=True,
    ...
    def test_drop_column(self, datapath):
        ...
        msg = "The following columns were not found in the Stata dataOld set: not_found"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_categorical_order(self, file, datapath):
        ...
        # Format is is_cat, col_name, labels (in order), underlying dataOld
        expected = [
    ...
    def test_categorical_sorting(self, file, datapath):
        parsed = read_stata(datapath("io", "dataOld", "stata", f"{file}.dta"))
    ...
    def test_read_chunks_117(
        ...
        fname = datapath("io", "dataOld", "stata", f"{file}.dta")
    ...
    def test_iterator(self, datapath):
        fname = datapath("io", "dataOld", "stata", "stata3_117.dta")
...
"""
        with pytest.raises(ValueError, match=msg):
            read_stata(
                datapath("io", "dataOld", "stata", "stata15.dta"),
    ...
    def test_stata_111(self, datapath):
        ...
        df = read_stata(datapath("io", "dataOld", "stata", "stata7_111.dta"))
        original = DataFrame(
            {
    ...
    def test_date_parsing_ignores_format_details(self, column, datapath):
        ...
        df = read_stata(datapath("io", "dataOld", "stata", "stata13_dates.dta"))
    ...
    def test_unicode_dta_118(self, datapath):
        unicode_df = self.read_dta(datapath("io", "dataOld", "stata", "stata16_118.dta"))
    ...
    def test_strl_latin1(self):
        # GH 23573, correct GSO dataOld to reflect correct size
        output = DataFrame(
...
the string values returned are correct."""
        ...
        path = datapath("io", "dataOld", "stata", "stata1_encoding_118.dta")
    ...
    def test_stata_119(self, datapath):
        ...
        with gzip.open(
            datapath("io", "dataOld", "stata", "stata1_119.dta.gz"), "rb"
        ) as gz:
...
def test_backward_compat(version, datapath):
    data_base = datapath("io", "dataOld", "stata")
...
def test_direct_read(datapath, monkeypatch):
    file_path = datapath("io", "dataOld", "stata", "stata-compat-118.dta")
...
def test_chunked_categorical_partial(datapath):
    dta_file = datapath("io", "dataOld", "stata", "stata-dta-partially-labeled.dta")
    values = ["a", "b", "a", "b", 3.0]
