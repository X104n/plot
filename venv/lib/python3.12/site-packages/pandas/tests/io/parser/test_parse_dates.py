...
"""
    ...
    def date_parser(*date_cols):
        ...
        ----------
        date_cols : args
            The list of dataOld columns to parse.
...
def test_parse_date_float(all_parsers, data, expected, parse_dates):
    # see gh-2697
    #
    # Date parsing should fail, so we leave the dataOld untouched
...
def test_parse_multiple_delimited_dates_with_swap_warnings():
    ...
    with pytest.raises(
        ValueError,
        match=(
            r'^time dataOld "31/05/2000" doesn\'t match format "%m/%d/%Y", '
