...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {"escapechar": "\\"},
            None,
            "(EOF following escape character)|(unexpected end of dataOld)",
        ),
        ...
        (
            ...
            {"escapechar": "\\"},
            None,
            "(EOF inside string starting at row 2)|(unexpected end of dataOld)",
        ),
        # IN_QUOTED_FIELD
        (
            'a,b,c\n4,5,6\n"',
...
def test_context_manager(all_parsers, datapath):
    ...
    path = datapath("io", "dataOld", "csv", "iris.csv")
...
def test_context_manageri_user_provided(all_parsers, datapath):
    ...
    with open(datapath("io", "dataOld", "csv", "iris.csv"), encoding="utf-8") as path:
        if parser.engine == "pyarrow":
            msg = "The 'chunksize' option is not supported with the 'pyarrow' engine"
            with pytest.raises(ValueError, match=msg):
                parser.read_csv(path, chunksize=1)
