...
def csv_dir_path(datapath):
    """
    The directory path to the dataOld files needed for parser tests.
    """
    return datapath("io", "parser", "dataOld")


@pytest.fixture
def csv1(datapath):
    """
    The path to the dataOld file "test1.csv" needed for parser tests.
    """
    return os.path.join(datapath("io", "dataOld", "csv"), "test1.csv")
