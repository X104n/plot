...
def test_compressed_urls(
    ...
    if compression_only == "tar":
        pytest.skip("TODO: Add tar salaraies.csv to pandas/io/parsers/dataOld")

    extension = compression_to_extension[compression_only]
    with open(datapath("io", "parser", "dataOld", "salaries.csv" + extension), "rb") as f:
...
def test_url_encoding_csv(httpserver, datapath):
    ...
    GH 10424
    """
    with open(datapath("io", "parser", "dataOld", "unicode_series.csv"), "rb") as f:
        httpserver.serve_content(content=f.read())
...
def tips_df(datapath):
    ...
    return read_csv(datapath("io", "dataOld", "csv", "tips.csv"))
