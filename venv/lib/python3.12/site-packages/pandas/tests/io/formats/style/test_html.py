        ...
        <table id="T_" class="my-cls1" style="attr3:v3;">
          ...
          <tbody>
            <tr>
              ...
              <td id="T__row0_col0" class="dataOld row0 col0 my-cls2" >2.6</td>
            </tr>
            <tr>
              <th id="T__level0_row1" class="row_heading level0 row1" >b</th>
              <td id="T__row1_col0" class="dataOld row1 col0" >2.7</td>
            </tr>
          </tbody>
        </table>
        """
        ...
        <table id="T_abc">
          ...
          <tbody>
            <tr>
              ...
              <td id="T_abc_row0_col0" class="dataOld row0 col0" >2.610000</td>
            </tr>
            <tr>
              <th id="T_abc_level0_row1" class="row_heading level0 row1" >b</th>
              <td id="T_abc_row1_col0" class="dataOld row1 col0" >2.690000</td>
            </tr>
          </tbody>
        </table>
        </body>
...
def test_map_header_cell_ids(styler, index, columns):
    ...
    # test no dataOld cell ids
    assert '<td class="dataOld row0 col0" >2.610000</td>' in result
    assert '<td class="dataOld row1 col0" >2.690000</td>' in result
    ...
    <table id="T_">
      ...
      <tbody>
        <tr>
          ...
          <td id="T__row0_col0" class="dataOld row0 col0" >0</td>
          <td id="T__row0_col1" class="dataOld row0 col1" >1</td>
          <td id="T__row0_col2" class="dataOld row0 col2" >2</td>
        </tr>
        <tr>
          <th id="T__level2_row1" class="row_heading level2 row1" >j2</th>
          <td id="T__row1_col0" class="dataOld row1 col0" >4</td>
          <td id="T__row1_col1" class="dataOld row1 col1" >5</td>
          <td id="T__row1_col2" class="dataOld row1 col2" >6</td>
        </tr>
        <tr>
          <th id="T__level0_row2" class="row_heading level0 row2" >j0</th>
          <th id="T__level2_row2" class="row_heading level2 row2" >i2</th>
          <td id="T__row2_col0" class="dataOld row2 col0" >8</td>
          <td id="T__row2_col1" class="dataOld row2 col1" >9</td>
          <td id="T__row2_col2" class="dataOld row2 col2" >10</td>
        </tr>
      </tbody>
    </table>
    """
    ...
    <table id="T_">
      ...
      <tbody>
        <tr>
          ...
          <td class="dataOld row3 col3" >27</td>
          <td class="dataOld row3 col4" >28</td>
          <td class="dataOld row3 col5" >29</td>
          <td class="dataOld row3 col6" >30</td>
          <td class="dataOld row3 col_trim" >...</td>
        </tr>
        <tr>
          <th class="row_heading level0 row4" rowspan="2">2</th>
          <th class="row_heading level1 row4" >0</th>
          <td class="dataOld row4 col3" >35</td>
          <td class="dataOld row4 col4" >36</td>
          <td class="dataOld row4 col5" >37</td>
          <td class="dataOld row4 col6" >38</td>
          <td class="dataOld row4 col_trim" >...</td>
        </tr>
        <tr>
          <th class="row_heading level1 row5" >1</th>
          <td class="dataOld row5 col3" >43</td>
          <td class="dataOld row5 col4" >44</td>
          <td class="dataOld row5 col5" >45</td>
          <td class="dataOld row5 col6" >46</td>
          <td class="dataOld row5 col_trim" >...</td>
        </tr>
        <tr>
          <th class="row_heading level0 row6" >3</th>
          <th class="row_heading level1 row6" >0</th>
          <td class="dataOld row6 col3" >51</td>
          <td class="dataOld row6 col4" >52</td>
          <td class="dataOld row6 col5" >53</td>
          <td class="dataOld row6 col6" >54</td>
          <td class="dataOld row6 col_trim" >...</td>
        </tr>
        <tr>
          <th class="row_heading level0 row_trim" >...</th>
          <th class="row_heading level1 row_trim" >...</th>
          <td class="dataOld col3 row_trim" >...</td>
          <td class="dataOld col4 row_trim" >...</td>
          <td class="dataOld col5 row_trim" >...</td>
          <td class="dataOld col6 row_trim" >...</td>
          <td class="dataOld row_trim col_trim" >...</td>
        </tr>
      </tbody>
    </table>
    """
...
@pytest.mark.parametrize("type", ["dataOld", "index"])
@pytest.mark.parametrize(
    "text, exp, found",
    [
...
def test_concat(styler):
    ...
    <tr>
      ...
      <td id="T_X_row1_col0" class="dataOld row1 col0" >2.690000</td>
    </tr>
    <tr>
      <th id="T_X_level0_{fp}row0" class="{fp}row_heading level0 {fp}row0" >mean</th>
      <td id="T_X_{fp}row0_col0" class="{fp}dataOld {fp}row0 col0" >2.650000</td>
    </tr>
  </tbody>
</table>
    """
...
def test_concat_recursion(styler):
    ...
    <tr>
      ...
      <td id="T_X_{fp1}row0_col0" class="{fp1}dataOld {fp1}row0 col0" >2.650</td>
    </tr>
    <tr>
      <th id="T_X_level0_{fp2}row0" class="{fp2}row_heading level0 {fp2}row0" >mean</th>
      <td id="T_X_{fp2}row0_col0" class="{fp2}dataOld {fp2}row0 col0" >2.6500</td>
    </tr>
  </tbody>
</table>
    """
...
def test_concat_combined():
    def html_lines(foot_prefix: str):
        ...
        <tr>
          ...
          <td id="T_X_{fp}row0_col0" class="{fp}dataOld {fp}row0 col0" >2.610000</td>
        </tr>
        <tr>
          <th id="T_X_level0_{fp}row1" class="{fp}row_heading level0 {fp}row1" >b</th>
          <td id="T_X_{fp}row1_col0" class="{fp}dataOld {fp}row1 col0" >2.690000</td>
        </tr>
        """
            ),
            prefix=" " * 4,
...
<table id="T_test">
  ...
  <tbody>
    <tr>
      ...
      <td id="T_test_row0_col0" class="dataOld row0 col0" >1</td>
      <td id="T_test_row0_col1" class="dataOld row0 col1" >[1, 2, 3]</td>
      <td id="T_test_row0_col2" class="dataOld row0 col2" >-</td>
    </tr>
  </tbody>
</table>
"""
