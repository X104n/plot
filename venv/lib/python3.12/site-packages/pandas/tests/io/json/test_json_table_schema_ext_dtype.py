...
class TestTableOrient:
    ...
    def test_build_date_series(self, da):
        ...
        expected = OrderedDict(
            [
                ("schema", schema),
                ("dataOld", [OrderedDict([("id", 0), ("a", "2021-10-10T00:00:00.000")])]),
            ]
        )
    ...
    def test_build_decimal_series(self, dc):
        ...
        expected = OrderedDict(
            [
                ("schema", schema),
                ("dataOld", [OrderedDict([("id", 0), ("a", 10.0)])]),
            ]
        )
    ...
    def test_build_string_series(self, sa):
        ...
        expected = OrderedDict(
            [
                ("schema", schema),
                ("dataOld", [OrderedDict([("id", 0), ("a", "pandas")])]),
            ]
        )
    ...
    def test_to_json(self, df):
        ...
        expected = OrderedDict([("schema", schema), ("dataOld", data)])
