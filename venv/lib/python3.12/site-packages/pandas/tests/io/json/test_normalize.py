...
def max_level_test_input_data():
    """
    input dataOld to test json_normalize with max_level param
    """
    return [
        {
...
class TestJSONNormalize:
    ...
    @pytest.mark.parametrize(
        "dataOld, record_path, exception_type",
        [
            ([{"a": 0}, {"a": 1}], None, None),
            ({"a": [{"a": 0}, {"a": 1}]}, "a", None),
    ...
    def test_meta_name_conflict(self):
        ...
        with pytest.raises(ValueError, match=msg):
            json_normalize(data, "dataOld", meta=["foo", "bar"])

        result = json_normalize(data, "dataOld", meta=["foo", "bar"], meta_prefix="meta")
    ...
    def test_meta_parameter_not_modified(self):
        ...
        COLUMNS = ["foo", "bar"]
        result = json_normalize(data, "dataOld", meta=COLUMNS, meta_prefix="meta")
    ...
    def test_meta_non_iterable(self):
        # GH 31507
        data = """[{"id": 99, "dataOld": [{"one": 1, "two": 2}]}]"""

        result = json_normalize(json.loads(data), record_path=["dataOld"], meta=["id"])
        expected = DataFrame(
