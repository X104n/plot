...
class TestPandasContainer:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                '"index":["1","2","3"],'
                '"dataOld":[[1.0,"1"],[2.0,"2"],[null,"3"]]}',
                "3 columns passed, passed dataOld had 2 columns",
                "split",
            ),
            # bad key
            (
    ...
    def test_v12_compat(self, datapath):
        ...
        dirpath = datapath("io", "json", "dataOld")
    ...
    def test_round_trip_exception(self, datapath):
        # GH 3867
        path = datapath("io", "json", "dataOld", "teams.csv")
        df = pd.read_csv(path)
        s = df.to_json()
    ...
    def test_to_jsonl(self):
        ...
        # GH15096: escaped characters in columns and dataOld
        df = DataFrame([["foo\\", "bar"], ['foo"', "bar"]], columns=["a\\", "b"])
        result = df.to_json(orient="records", lines=True)
        expected = '{"a\\\\":"foo\\\\","b":"bar"}\n{"a\\\\":"foo\\"","b":"bar"}\n'
        assert result == expected
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Series([1, 2, 3], name="A"), {"name": "A", "dataOld": [1, 2, 3]}),
            (
                Series([1, 2, 3], name="A").rename_axis("foo"),
                {"name": "A", "dataOld": [1, 2, 3]},
            ),
            (
    ...
    def test_index_false_to_json_table(self, data):
        ...
        expected = {
            ...
            "dataOld": DataFrame(data).to_dict(orient="records"),
        }
...
{spaces}}}
    ...
    def test_json_uint64(self):
        ...
        expected = (
            ...
            '"dataOld":[[13342205958987758245],[12388075603347835679]]}'
        )
