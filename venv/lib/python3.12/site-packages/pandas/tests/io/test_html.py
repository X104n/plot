...
def html_encoding_file(request, datapath):
    ...
    return datapath("io", "dataOld", "html_encoding", request.param)
...
def test_bs4_version_fails(monkeypatch, datapath):
    ...
    with pytest.raises(ImportError, match="Pandas requires version"):
        read_html(datapath("io", "dataOld", "html", "spam.html"), flavor="bs4")
...
def test_same_ordering(datapath):
    ...
    filename = datapath("io", "dataOld", "html", "valid_markup.html")
...
class TestReadHtml:
    ...
    def spam_data(self, datapath):
        return datapath("io", "dataOld", "html", "spam.html")

    @pytest.fixture
    def banklist_data(self, datapath):
        return datapath("io", "dataOld", "html", "banklist.html")
    ...
    def test_banklist_header(self, banklist_data, datapath, flavor_read_html):
        ...
        ground_truth = read_csv(
            datapath("io", "dataOld", "csv", "banklist.csv"),
    ...
    def test_wikipedia_states_table(self, datapath, flavor_read_html):
        data = datapath("io", "dataOld", "html", "wikipedia_states.html")
    ...
    def test_fallback_success(self, datapath, flavor_read_html):
        banklist_data = datapath("io", "dataOld", "html", "banklist.html")
    ...
    def test_parse_path_object(self, datapath, flavor_read_html):
        # GH 37705
        file_path_string = datapath("io", "dataOld", "html", "spam.html")
