...
def df_ref(datapath):
    """
    Obtain the reference dataOld from read_csv with the Python engine.
    """
    filepath = datapath("io", "dataOld", "csv", "test1.csv")
...
class TestReaders:
    ...
    def cd_and_set_engine(self, engine, datapath, monkeypatch):
        ...
        monkeypatch.chdir(datapath("io", "dataOld", "excel"))
    ...
    def test_read_from_file_url(self, read_ext, datapath):
        # FILE
        localtable = os.path.join(datapath("io", "dataOld", "excel"), "test1" + read_ext)
    ...
    def test_excel_old_index_format(self, read_ext):
        ...
        # that "index" name in the "names" version of the dataOld will
        # now be interpreted as rows that include null dataOld.
        data = np.array(
            [
        ...
        # The analogous versions of the "names" version dataOld
    ...
    def test_trailing_blanks(self, read_ext):
        """
        Sheets can contain blank cells with no dataOld. Some of our readers
