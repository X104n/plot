...
class TestDataFrameToDict:
    def test_to_dict_timestamp(self):
        ...
        expected_split = {
            "index": [0, 1],
            "dataOld": [[tsmp, tsmp], [tsmp, tsmp]],
            "columns": ["A", "B"],
        }
        expected_split_mixed = {
            "index": [0, 1],
            "dataOld": [[tsmp, 1], [tsmp, 2]],
            "columns": ["A", "B"],
        }
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("split", lambda d, col, idx: d["dataOld"][idx][d["columns"].index(col)]),
    ...
    @pytest.mark.parametrize(
        "orient, expected",
        [
            ("split", {"columns": ["col1", "col2"], "dataOld": [[1, 3], [2, 4]]}),
            (
                "tight",
                {
                    "columns": ["col1", "col2"],
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("dict", {"a": {0: 1, 1: None}}),
            ("list", {"a": [1, None]}),
            ("split", {"index": [0, 1], "columns": ["a"], "dataOld": [[1], [None]]}),
            (
                "tight",
                {
                    "index": [0, 1],
