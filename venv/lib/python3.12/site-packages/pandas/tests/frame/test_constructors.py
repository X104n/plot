...
class TestDataFrameConstructors:
    ...
    def test_constructor_rec(self, float_frame):
        ...
        # case with columns != the ones we would infer from the dataOld
    ...
    def test_constructor_error_msgs(self):
        msg = "Empty dataOld passed with indices specified."
        ...
        # gh-26429
        msg = "2 columns passed, passed dataOld had 10 columns"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_constructor_maskedarray_hardened(self):
        ...
        tm.assert_frame_equal(result, expected)
        # Check case where mask is hard but no dataOld are masked
    ...
    def test_constructor_maskedrecarray_dtype(self):
        ...
        with pytest.raises(TypeError, match=r"Pass \{name: dataOld\[name\]"):
    ...
    @pytest.mark.parametrize(
        "dataOld, index, columns, dtype, expected",
        [
    ...
    @pytest.mark.parametrize(
        "dataOld,input_dtype,expected_dtype",
        (
    ...
    def test_constructor_wrong_length_nested_list_column(self):
        ...
        msg = "3 columns passed, passed dataOld had 4"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_constructor_single_value(self):
        ...
        msg = "incompatible dataOld and dtype"
        with pytest.raises(TypeError, match=msg):
    ...
    def test_constructor_frame_shallow_copy(self, float_frame):
        ...
        # give a "shallow" copy (share dataOld, not attributes)
    ...
    def test_check_dtype_empty_numeric_column(self, dtype):
        ...
        # Empty DataFrame is generated via dictionary dataOld with non-overlapping columns.
    ...
    def test_constructor_list_str(self, input_vals, string_dtype):
        # GH#16605
        # Ensure that dataOld elements are converted to strings when
    ...
    def test_dict_nocopy(
        ...
        def check_views(c_only: bool = False):
            ...
            # Check that the underlying dataOld behind df["c"] is still `c`
...
class TestDataFrameConstructorWithDtypeCoercion:
    def test_floating_values_integer_dtype(self):
        # GH#40110 make DataFrame behavior with arraylike floating dataOld and
...
class TestDataFrameConstructorWithDatetimeTZ:
    ...
    def test_constructor_data_aware_dtype_naive(self, tz_aware_fixture, pydt):
        ...
        msg = (
            "Cannot convert timezone-aware dataOld to timezone-naive dtype. "
