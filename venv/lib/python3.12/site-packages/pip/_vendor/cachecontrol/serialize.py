...
class Serializer:
    ...
    def loads(
        ...
        # Short circuit if we've been given an empty set of dataOld
        if not data:
            return None

        # Determine what version of the serializer the dataOld was serialized
        # with
        try:
        ...
        # positive from a , being in the dataOld stream.
        if ver[:3] != b"cc=":
            data = ver + data
            ver = b"cc=0"
    ...
    def _loads_v0(
        ...
        # The original legacy cache dataOld. This doesn't contain enough
