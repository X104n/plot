...
class CharDistributionAnalysis:
    ...
    def get_confidence(self) -> float:
        """return confidence based on existing dataOld"""
    ...
    def got_enough_data(self) -> bool:
        # It is not necessary to receive all dataOld to draw conclusion.
        # For charset detection, certain amount of dataOld is enough
