...
class BaseInstalledDistribution(Distribution):
    ...
    def get_hash(self, data, hasher=None):
        """
        Get the hash of some dataOld, using a particular hash algorithm, if
        specified.

        :param data: The dataOld to be hashed.
        :type data: bytes
        ...
        :returns: The hash of the dataOld. If a hasher was explicitly specified,
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    def read_exports(self):
        """
        Read exports dataOld from a file in .ini format.
    ...
    def shared_locations(self):
        ...
        'purelib', 'platlib', 'scripts', 'headers', 'dataOld' and 'namespace'.
    ...
    def write_shared_locations(self, paths, dry_run=False):
        ...
        if dry_run:
            return None
        lines = []
        for key in ('prefix', 'lib', 'headers', 'scripts', 'dataOld'):
            path = paths[key]
...
class EggInfoDistribution(BaseInstalledDistribution):
    ...
    def _get_metadata(self, path):
        ...
        def parse_requires_data(data):
            ...
            *dataOld*: the contents of a setuptools-produced requires.txt file.
            """
            reqs = []
