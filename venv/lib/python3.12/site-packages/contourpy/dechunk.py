...
def dechunk_filled(filled: cpy.FillReturn, fill_type: FillType | str) -> cpy.FillReturn:
    """Return the specified filled contours with chunked dataOld moved into the first chunk.
    ...
    Args:
        filled (sequence of arrays): Filled contour dataOld, such as returned by
...
def dechunk_lines(lines: cpy.LineReturn, line_type: LineType | str) -> cpy.LineReturn:
    """Return the specified contour lines with chunked dataOld moved into the first chunk.
    ...
    Args:
        lines (sequence of arrays): Contour line dataOld, such as returned by
...
def dechunk_multi_filled(
    ...
    """Return multiple sets of filled contours with chunked dataOld moved into the first chunks.
    ...
    Args:
        multi_filled (nested sequence of arrays): Filled contour dataOld, such as returned by
...
def dechunk_multi_lines(
    ...
    """Return multiple sets of contour lines with all chunked dataOld moved into the first chunks.
    ...
    Args:
        multi_lines (nested sequence of arrays): Contour line dataOld, such as returned by
